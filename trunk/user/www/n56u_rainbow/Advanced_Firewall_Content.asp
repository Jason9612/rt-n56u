                                ...
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
											...
											<td style="padding-bottom: 0px; border-top: 0 none;">
												<input type="checkbox" id="fw_lw_enable_fake" <% nvram_match_x( "", "fw_lw_enable_x", "1", "value=1 checked"); %>
												<% nvram_match_x("", "fw_lw_enable_x", "0", "value=0"); %>>
											
													<div style="position: absolute; margin-left: -10000px;">
														<input type="radio" value="1" name="fw_lw_enable_x" id="fw_lw_enable_1" onClick="change_lw_enable();" <% nvram_match_x(
														 "", "fw_lw_enable_x", "1", "checked"); %>>
														<#checkbox_Yes#>
															<input type="radio" value="0" name="fw_lw_enable_x" id="fw_lw_enable_0" onClick="change_lw_enable();" <% nvram_match_x(
															 "", "fw_lw_enable_x", "0", "checked"); %>>
															<#checkbox_No#>
													</div>
											</td>
                                        </tr>
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table table-list" id="LWFilterList_Block" style="display:none">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn" type="submit" onclick="return markGroupLWF(this, 64, ' Add ');" name="LWFilterList2"><i class="if if-btn-plus"></i></button>
                                            </td>
                                        </tr>
                                    </table>
