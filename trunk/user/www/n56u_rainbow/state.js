...
function show_banner(L3) {
	...
	bc += '    <td><button type="button" id="logout_btn" class="btn btn-mini" style="height: 21px; outline:0;" title="<#t1Logout#>" onclick="logout();"><i class="if if-banner-signout"></i></button> <button type="button" id="reboto_btn" class="btn btn-mini" style="height: 21px; outline:0;" title="<#BTN_REBOOT#>" onclick="reboot();"><i class="if if-banner-restart"></i></button> <button type="button" id="shutdown_btn" class="btn btn-mini" style="height: 21px; outline:0;" title="<#BTN_SHUTDOWN#>" onclick="shutdown();"><i class="if if-banner-poweroff"></i></button><div class="btn-group theme pull-left"><button type="button" class="btn btn-mini dropdown-toggle" data-toggle="dropdown"><i class="if if-banner-theme"></i></button><ul class="dropdown-menu" role="menu"><li class="red"><a href="#"></a></li><li class="orange"><a href="#"></a></li><li class="yellow"><a href="#"></a></li><li class="green"><a href="#"></a></li><li class="cyan"><a href="#"></a></li><li class="blue"><a href="#"></a></li><li class="purple"><a href="#"></a></li></ul></div></td>\n';
	bc += '  </tr>\n';
	bc += '</table>\n';
	bc += '</div>\n';
	bc += '</div>\n';
...
var tabM8 = [
	...
	{ "title": "", "link": "" },//Main_EStatus_Content.asp#0
	{ "title": "", "link": "" },
	{ "title": "", "link": "" },
	{ "title": "", "link": "" },
	{ "title": "", "link": "" },
...
//Level 1 Menu
var menuL1 = [
	{ "title": "<#menu1#>", "link": "index.asp", "icon": "if-m1-netmap" },
	{ "title": "<#menu2#>", "link": "vpnsrv.asp", "icon": "if-m1-vpnserver" },
	{ "title": "<#menu6#>", "link": "vpncli.asp", "icon": "if-m1-vpnclient" },
	{ "title": "<#menu4#>", "link": "Main_TrafficMonitor_realtime.asp", "icon": "if-m1-netmonitor" },
	{ "title": "<#menu5_8#>", "link": "Advanced_System_Info.asp", "icon": "if-m1-sysinfo" },
	{ "title": "<#menu5#>", "link": "as.asp", "icon": "if-m1-syssettings" }
];

//Level 2 Menu
var menuL2 = [
	{ "title": "<#menu5_11#>", "link": tabMenuHash.get('if-m2-2gwifi')[0].link, "icon": "if-m2-2gwifi" },
	{ "title": "<#menu5_12#>", "link": tabMenuHash.get('if-m2-5gwifi')[0].link, "icon": "if-m2-5gwifi" },
	{ "title": "<#menu5_2#>", "link": tabMenuHash.get('if-m2-lan')[0].link, "icon": "if-m2-lan" },
	{ "title": "<#menu5_3#>", "link": tabMenuHash.get('if-m2-wan')[0].link, "icon": "if-m2-wan" },
	{ "title": "<#menu5_5#>", "link": tabMenuHash.get('if-m2-firewall')[0].link, "icon": "if-m2-firewall" },
	{ "title": "<#menu5_4#>", "link": tabMenuHash.get('if-m2-usbapp')[0].link, "icon": "if-m2-usbapp" },
	{ "title": "<#menu5_6#>", "link": tabMenuHash.get('if-m2-sysconfig')[0].link, "icon": "if-m2-sysconfig" },
	{ "title": "<#menu5_10#>", "link": tabMenuHash.get('if-m2-sysparams')[0].link, "icon": "if-m2-sysparams" },
	{ "title": "<#menu5_9#>", "link": support_2g_radio() ? tabMenuHash.get('if-m2-netinfo')[0].link : "Main_EStatus_Content.asp", "icon": "if-m2-netinfo" },
	{ "title": "<#menu5_7#>", "link": tabMenuHash.get('if-m2-syslog')[0].link, "icon": "if-m2-syslog" }
];

/* plugin menu 插件菜单 */
if (found_app_scutclient()) {
	var mx = { "title": "<#menu5_13#>", "link": "scutclient.asp", "icon": "if-m2-scutclient" };
	var mx2 = [mx, { "title": "<#menu5_13_log#>", "link": "scutclient_log.asp" }];
	menuL2.push(mx);
	//tabM.push(mx2);
	tabMenuHash.put('if-m2-scutclient', mx2);
}
if (found_app_dnsforwarder()) {
	var mx = { "title": "<#menu5_15#>", "link": "dns-forwarder.asp", "icon": "if-m2-dnsforwarder" };
	var mx2 = [mx];
	menuL2.push(mx);
	//tabM.push(mx2);
...
if (found_app_shadowsocks()) {
	var mx = { "title": "<#menu5_16#>", "link": "Shadowsocks.asp", "icon": "if-m2-ssr" };
...
if (found_app_mentohust()) {
	var mx = { "title": "<#menu5_18#>", "link": "mentohust.asp", "icon": "if-m2-mentohust" };
...
if (found_app_adbyby() && !found_app_koolproxy()) {
	var mx = { "title": "<#menu5_20#>", "link": "Advanced_adbyby.asp", "icon": "if-m2-adguard" };
...
if (!found_app_adbyby() && found_app_koolproxy()) {
	var mx = { "title": "<#menu5_20#>", "link": "Advanced_koolproxy.asp", "icon": "if-m2-adguard" };
...
if (found_app_smartdns() && !found_app_adguardhome()) {
	var mx = { "title": "<#menu5_29#>", "link": "Advanced_smartdns.asp", "icon": "if-m2-dnsservice" };
...
if (!found_app_smartdns() && found_app_adguardhome()) {
	var mx = { "title": "<#menu5_29#>", "link": "Advanced_adguardhome.asp", "icon": "if-m2-dnsservice" };
...
if (found_app_aliddns() && !found_app_zerotier()) {
	var mx = { "title": "<#menu5_30#>", "link": "Advanced_aliddns.asp", "icon": "if-m2-zerotier" };
...
if (!found_app_aliddns() && found_app_zerotier()) {
	var mx = { "title": "<#menu5_30#>", "link": "Advanced_zerotier.asp", "icon": "if-m2-zerotier" };
...
if (found_app_frp()) {
	var mx = { "title": "<#menu5_25#>", "link": "Advanced_frp.asp", "icon": "if-m2-frp" };
...
if (found_app_caddy()) {
	var mx = { "title": "<#menu5_27#>", "link": "Advanced_caddy.asp", "icon": "if-m2-caddy" };
	var mx2 = [{ "title": "<#menu5_27_1#>", "link": "Advanced_caddy.asp" }];
	menuL2.push(mx);
	//tabM.push(mx2);
	tabMenuHash.put('if-m2-caddy', mx2);
}
if (found_app_wyy()) {
	var mx = { "title": "<#menu5_31#>", "link": "Advanced_wyy.asp", "icon": "if-m2-unlockmusic" };
	var mx2 = [{ "title": "<#menu5_31_1#>", "link": "Advanced_wyy.asp" }];
	menuL2.push(mx);
	//tabM.push(mx2);
	tabMenuHash.put('if-m2-unlockmusic', mx2);
}
/* plugin menu 插件菜单 结束*/
...
function show_menu(L1, L2, L3) {
	...
	for (var i = 0; i < num_ephy; i++) {
		...
		if (i == 0)
			tabMenuHash.get('if-m2-netinfo')[i + 2] = { "title": "WAN", "link": "Main_EStatus_Content.asp#" + i.toString() };
		else
			tabMenuHash.get('if-m2-netinfo')[i + 2] = { "title": "LAN" + i.toString(), "link": "Main_EStatus_Content.asp#" + i.toString() };
	}
	if (num_ephy < 8) {
...
jQuery.each(menuL1, function (i, m) {
	var hidden = false;
	if (w_vpn_s === '0' && m.icon == 'if-m1-vpnserver') {
		hidden = true;
	}
	else if (w_vpn_c === '0' && m.icon == 'if-m1-vpnclient') {
		hidden = true;
	}
	else if (w_wnet === '0' && m.icon == 'if-m1-netmonitor') {
		hidden = true;
	}
	else if (w_sys === '0' && m.icon == 'if-m1-sysinfo') {
		hidden = true;
	}
	if (hidden) {
		m.title = '';
...
jQuery.each(menuL2, function (i, m) {
	var hidden = false;
	if (w_usb === '0' && m.icon == 'if-m2-usbapp') {
		hidden = true;
	}
	else if (w_net === '0' && m.icon == 'if-m2-netinfo') {
		hidden = true;
	}
	else if (w_log === '0' && m.icon == 'if-m2-syslog') {
		hidden = true;
	}
	else if (w_scu === '0' && m.icon == 'if-m2-scutclient') {
		hidden = true;
	}
	else if (w_dnsf === '0' && m.icon == 'if-m2-dnsforwarder') {
		hidden = true;
	}
	else if (w_ss === '0' && m.icon == 'if-m2-ssr') {
		hidden = true;
	}
	else if (w_men === '0' && m.icon == 'if-m2-mentohust') {
		hidden = true;
	}
	else if (w_adbyby === '0' && m.icon == 'if-m2-adguard') {
		hidden = true;
	}
	else if (w_pdnsd === '0' && m.icon == 'if-m2-dnsservice') {
		hidden = true;
	}
	if (hidden) {
		m.title = '';
