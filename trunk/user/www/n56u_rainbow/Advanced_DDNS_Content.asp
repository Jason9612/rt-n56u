                                ...
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
											...
											<td>
												<input type="checkbox" id="ddns_enable_x_fake" <% nvram_match_x( "", "ddns_enable_x", "1", "value=1 checked"); %>
												<% nvram_match_x("", "ddns_enable_x", "0", "value=0"); %>>
											
													<div style="position: absolute; margin-left: -10000px;">
														<input type="radio" value="1" name="ddns_enable_x" id="ddns_enable_x_1" onClick="change_ddns_enabled();" <% nvram_match_x(
														 "", "ddns_enable_x", "1", "checked"); %>>
														<#checkbox_Yes#>
															<input type="radio" value="0" name="ddns_enable_x" id="ddns_enable_x_0" onClick="change_ddns_enabled();" <% nvram_match_x(
															 "", "ddns_enable_x", "0", "checked"); %>>
															<#checkbox_No#>
													</div>
											</td>
                                        </tr>
                                        ...
                                        <tr id="row_ddns_pass">
                                            ...
                                            <td>
                                                <div class="input-append">
                                                    ...
                                                    <button style="margin-left: -5px;" class="btn" type="button" onclick="passwordShowHide('ddns_passwd_x')"><i class="if if-btn-eyeclose"></i></button>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr id="row_ddns2_pass">
                                            ...
                                            <td>
                                                <div class="input-append">
                                                    ...
                                                    <button style="margin-left: -5px;" class="btn" type="button" onclick="passwordShowHide('ddns2_pass')"><i class="if if-btn-eyeclose"></i></button>
                                                </div>
                                            </td>
                                        </tr>
