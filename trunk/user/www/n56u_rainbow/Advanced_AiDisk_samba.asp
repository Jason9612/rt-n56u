														...
														<table cellspacing="0" cellpadding="0"
															...
															<tr>
																<td width="220" align="left"
																	...
																	<i
																		class="if if-device-router"></i><span><% nvram_get_x("", "productid"); %></span>
																</td>
