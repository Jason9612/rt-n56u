                                ...
                                <div id="wnd_vpnc_cfg">
                                    ...
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td style="padding-bottom: 0px; border-top: 0 none;">
                                                ...
                                                <input type="checkbox" id="vpnc_enable_fake" <% nvram_match_x( "", "vpnc_enable", "1", "value=1 checked"); %>
                                                <% nvram_match_x("", "vpnc_enable", "0", "value=0"); %>>

                                                    <div style="position: absolute; margin-left: -10000px;">
                                                        <input type="radio" name="vpnc_enable" id="vpnc_enable_1" class="input" value="1" onclick="change_vpnc_enabled();" <% nvram_match_x(
                                                            "", "vpnc_enable", "1", "checked"); %>>
                                                        <#checkbox_Yes#>
                                                            <input type="radio" name="vpnc_enable" id="vpnc_enable_0" class="input" value="0" onclick="change_vpnc_enabled();" <% nvram_match_x(
                                    ...
                                    <table class="table" id="tbl_vpnc_config" style="display:none">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="vpnc_peer" class="input" maxlength="256" size="32" value="<% nvram_get_x(" ", "vpnc_peer "); %>"
                                        ...
                                        <tr id="row_vpnc_ov_port" style="display:none">
                                            ...
                                            <td>
                                                <input type="text" maxlength="5" size="5" name="vpnc_ov_port" class="input" value="<% nvram_get_x(" ", "vpnc_ov_port
                                        ...
                                        <tr id="row_vpnc_user">
                                            ...
                                            <td>
                                                <input type="text" maxlength="64" class="input" size="32" name="vpnc_user" value="<% nvram_get_x(" ", "vpnc_user "); %>"
                                                    onkeypress="return is_string(this,event);" />
                                            </td>
                                        </tr>
                                        <tr id="row_vpnc_pass">
                                            ...
                                            <td>
                                                <div class="input-append">
                                                    <input type="password" maxlength="64" class="input" size="32" name="vpnc_pass" id="vpnc_pass" style="width: 175px;" value="<% nvram_get_x("
                                                        ", "vpnc_pass "); %>"/>
                                        ...
                                        <tr id="row_vpnc_pppd">
                                            ...
                                            <td style="padding-bottom: 0px;">
                                                <input type="text" name="vpnc_pppd" value="<% nvram_get_x(" ", "vpnc_pppd "); %>" class="input" maxlength="255" size="32"
                                                    onKeyPress="return is_string(this,event);" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr id="row_vpnc_ov_ciph" style="display:none">
                                            ...
                                            <td>
                                                <select name="vpnc_ov_ciph" class="input">
                                                    ...
                                                    <option value="9" <% nvram_match_x(
                                                        "", "vpnc_ov_ciph", "9", "selected"); %>>[CAMELLIA-128-CBC] CAM, 128 bit</option>
                                                
                                                    <option value="10" <% nvram_match_x(
                                                        "", "vpnc_ov_ciph", "10", "selected"); %>>[CAMELLIA-192-CBC] CAM, 192 bit</option>
                                                
                                                    <option value="11" <% nvram_match_x(
                                                        "", "vpnc_ov_ciph", "11", "selected"); %>>[CAMELLIA-256-CBC] CAM, 256 bit</option>
                                                
                                                    <option value="12" <% nvram_match_x(
                                                        "", "vpnc_ov_ciph", "12", "selected"); %>>[AES-128-GCM] AES-GCM, 128 bit</option>
                                                
                                                    <option value="13" <% nvram_match_x(
                                                        "", "vpnc_ov_ciph", "13", "selected"); %>>[AES-192-GCM] AES-GCM, 192 bit</option>
                                                
                                                    <option value="14" <% nvram_match_x(
                                                        "", "vpnc_ov_ciph", "14", "selected"); %>>[AES-256-GCM] AES-GCM, 256 bit</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr id="row_vpnc_ov_clzo" style="display:none">
                                            ...
                                            <td>
                                                <select name="vpnc_ov_clzo" class="input">
                                                    <option value="0" <% nvram_match_x( "", "vpnc_ov_clzo", "0", "selected"); %>>
                                                        <#btn_Disable#>
                                                    </option>
                                                    <option value="1" <% nvram_match_x( "", "vpnc_ov_clzo", "1", "selected"); %>>
                                                        <#OVPN_CLZO_Item1#>
                                                    </option>
                                                    <option value="2" <% nvram_match_x( "", "vpnc_ov_clzo", "2", "selected"); %>>
                                                        <#OVPN_CLZO_Item2#> (*)</option>
                                                    <option value="3" <% nvram_match_x( "", "vpnc_ov_clzo", "3", "selected"); %>>
                                                        <#OVPN_CLZO_Item3#>
                                                    </option>
                                                </select>
                                            </td>
                                        ...
                                        <tr id="row_vpnc_ov_atls" style="display:none">
                                            ...
                                            <td>
                                                <select name="vpnc_ov_atls" class="input" onchange="change_vpnc_ov_atls();">
                                                    <option value="0" <% nvram_match_x( "", "vpnc_ov_atls", "0", "selected"); %>>
                                                        <#checkbox_No#>
                                                    </option>
                                                    <option value="1" <% nvram_match_x( "", "vpnc_ov_atls", "1", "selected"); %>>
                                                        <#OVPN_HMAC_Item1#>
                                                    </option>
                                                </select>
                                            </td>
                                        ...
                                        <tr id="row_vpnc_ov_cnat" style="display:none">
                                            ...
                                            <td>
                                                <select name="vpnc_ov_cnat" class="input">
                                                    <option value="0" <% nvram_match_x( "", "vpnc_ov_cnat", "0", "selected"); %>>
                                                        <#OVPN_Topo1#>
                                                    </option>
                                                    <option value="1" <% nvram_match_x( "", "vpnc_ov_cnat", "1", "selected"); %>>
                                                        <#OVPN_Topo2#>
                                                    </option>
                                                </select>
                                            </td>
                                    ...
                                    <table class="table" id="tbl_vpnc_route" style="display:none">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" maxlength="15" size="14" name="vpnc_rnet" style="width: 94px;" value="<% nvram_get_x(" ", "vpnc_rnet
                                                    "); %>" onKeyPress="return is_ipaddr(this,event);" />&nbsp;/
                                                <input type="text" maxlength="15" size="14" name="vpnc_rmsk" style="width: 94px;" value="<% nvram_get_x(" ", "vpnc_rmsk
                                                    "); %>" onKeyPress="return is_ipaddr(this,event);" />
                                            </td>
                                        </tr>
                                    </table>
