...
<body onload="initial();" onunLoad="return unload_body();">
	...
	<div class="wrapper">
		...
		<form method="post" name="form" id="ruleForm" action="/start_apply.htm" target="hidden_frame">
			...
			<input type="hidden" name="adbybyip_staticnum_x_0"
				value="<% nvram_get_x("AdIPList", "adbybyip_staticnum_x"); %>" readonly="1" />
			<input type="hidden" name="adbybyrules_staticnum_x_0"
				value="<% nvram_get_x("AdRULESList", "adbybyrules_staticnum_x"); %>" readonly="1" />
								...
								<div class="box well grad_colour_dark_blue">
									...
									<div class="round_bottom">
										...
										<div class="row-fluid">
											...
											<div class="alert alert-info" style="margin: 10px;">广告屏蔽大师 Plus +
												可以全面过滤各种横幅、弹窗、视频广告，同时阻止跟踪、隐私窃取及各种恶意网站<br />
												<div>Plus + 版本可以和 Hosts 结合方式运行，过滤广告不损失带宽</div>
												<div>anti-AD项目地址:<a
														href="https://github.com/privacy-protection-tools/anti-AD">https://github.com/privacy-protection-tools/anti-AD</a>
												</div>
												<div>静态规则：【<% nvram_get_x("", "adbyby_ltime"); %>】 |
													视频规则：【<% nvram_get_x("", "adbyby_vtime"); %>】</div>
												<div>anti-AD规则：【<% nvram_get_x("", "anti_ad_count"); %>】条 | Hosts
													AD：【<% nvram_get_x("", "adbyby_hostsad"); %>】条</div>
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0"
												...
												<tr>
													<th width="50%">启用 Adbyby 功能 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
														&nbsp; &nbsp;</th>
													<td>
														<input type="checkbox" id="adbyby_enable_fake"
															<% nvram_match_x( "", "adbyby_enable", "1", "value=1 checked"); %>
															<% nvram_match_x("", "adbyby_enable", "0", "value=0"); %> />

														<div style="position: absolute; margin-left: -10000px;">
															<input type="radio" value="1" name="adbyby_enable"
																id="adbyby_enable_1" class="input" <% nvram_match_x( "",
														 "adbyby_enable", "1", "checked"); %> />
															<#checkbox_Yes#>
																<input type="radio" value="0" name="adbyby_enable"
																	id="adbyby_enable_0" class="input" <% nvram_match_x( "",
															 "adbyby_enable", "0", "checked"); %> />
																<#checkbox_No#>
														</div>
													</td>
												</tr>
												<tr>
													<th width="50%">
														<a class="help_tooltip" href="javascript: void(0)"
															onmouseover="openTooltip(this, 0, 1);">过滤方案选择:</a></th>
													<td>
														<select name="adbyby_set" class="input">
															<option value="0"
																<% nvram_match_x("","adbyby_set", "0","selected"); %>>
																全局模式（推荐），全部IP走adbyby过滤</option>
															<option value="1"
																<% nvram_match_x("","adbyby_set", "1","selected"); %>>
																Plus + 模式(只过滤列表内域名结合ABP名单)</option>
															<option value="2"
																<% nvram_match_x("","adbyby_set", "2","selected"); %>>
																内网IP列表控制模式</option>
														</select>
													</td>
												</tr>
												<tr id="adbyby_update_tr">
													...
													<td>
														<select name="adbyby_update" class="input" style="width: 60px;">
															<option value="0"
																<% nvram_match_x("","adbyby_update", "0","selected"); %>>
																每天</option>
															<option value="1"
																<% nvram_match_x("","adbyby_update", "1","selected"); %>>
																每隔</option>
															<option value="2"
																<% nvram_match_x("","adbyby_update", "2","selected"); %>>
																关闭</option>
														</select>
														<select name="adbyby_update_hour" id="adbyby_update_hour"
															class="input" style="width: 50px">

														</select>时
														<select name="adbyby_update_min" id="adbyby_update_min"
															class="input" style="width: 50px">
												...
												<tr>
													...
													<td>
														...
														<input type="checkbox" id="block_ios_fake"
															<% nvram_match_x( "", "block_ios", "1", "value=1 checked"); %>
															<% nvram_match_x("", "block_ios", "0", "value=0"); %> />

														<div style="position: absolute; margin-left: -10000px;">
															<input type="radio" value="1" name="block_ios"
																id="block_ios_1" class="input" value="1" <% nvram_match_x( "", "block_ios",
														 "1", "checked"); %> />
															<#checkbox_Yes#>
																<input type="radio" value="0" name="block_ios"
																	id="block_ios_0" class="input" value="0" <% nvram_match_x( "", "block_ios",
															 "0", "checked"); %> />
																<#checkbox_No#>
														</div>
													</td>
												...
												<tr>
													...
													<td>
														...
														<input type="checkbox" id="block_douyin_fake"
															<% nvram_match_x( "", "block_douyin", "1", "value=1 checked"); %>
															<% nvram_match_x("", "block_douyin", "0", "value=0"); %> />

														<div style="position: absolute; margin-left: -10000px;">
															<input type="radio" value="1" name="block_douyin"
																id="block_douyin_1" class="input" value="1" <% nvram_match_x( "",
														 "block_douyin", "1", "checked"); %> />
															<#checkbox_Yes#>
																<input type="radio" value="0" name="block_douyin"
																	id="block_douyin_0" class="input" value="0" <% nvram_match_x( "",
															 "block_douyin", "0", "checked"); %> />
																<#checkbox_No#>
														</div>
													</td>
												</tr>
												<tr>
													<th width="50%">
														<a class="help_tooltip" href="javascript: void(0)"
															onmouseover="openTooltip(this, 2, 1);">加载anti-AD项目规则:</a>
													</th>
													<td>

														<input type="checkbox" id="anti_ad_fake"
															<% nvram_match_x( "", "anti_ad", "1", "value=1 checked"); %>
															<% nvram_match_x("", "anti_ad", "0", "value=0"); %> />

														<div style="position: absolute; margin-left: -10000px;">
															<input type="radio" value="1" name="anti_ad" id="anti_ad_1"
																class="input" value="1" <% nvram_match_x( "", "anti_ad", "1",
														 "checked"); %> />
															<#checkbox_Yes#>
																<input type="radio" value="0" name="anti_ad"
																	id="anti_ad_0" class="input" value="0" <% nvram_match_x( "", "anti_ad", "0",
															 "checked"); %> />
																<#checkbox_No#>
														</div>
													</td>
												...
												<tr>
													...
													<td>
														<input type="text" class="input" size="60" name="anti_ad_link"
															value="<% nvram_get_x("","anti_ad_link"); %>" />
													</td>
												</tr>
												<tr>
													<th width="50%">加载hosts规则</th>
													<td>
														<input type="checkbox" id="hosts_ad_fake"
															<% nvram_match_x( "", "hosts_ad", "1", "value=1 checked"); %>
															<% nvram_match_x("", "hosts_ad", "0", "value=0"); %> />

														<div style="position: absolute; margin-left: -10000px;">
															<input type="radio" value="1" name="hosts_ad"
																id="hosts_ad_1" class="input" value="1" <% nvram_match_x( "", "hosts_ad",
														 "1", "checked"); %> />
															<#checkbox_Yes#>
																<input type="radio" value="0" name="hosts_ad"
																	id="hosts_ad_0" class="input" value="0" <% nvram_match_x( "", "hosts_ad",
															 "0", "checked"); %> />
																<#checkbox_No#>
														</div>
													</td>
												...
												<tr>
													<td colspan="3">
														<i class="if if-tip-hand-right"></i> <a
															href="javascript:spoiler_toggle('script15')"><span>hosts规则下载列表(一行一个地址):</span></a>
														<div id="script15">
															<textarea rows="8" wrap="off" spellcheck="false"
																maxlength="314571" class="span12"
																name="scripts.adbyby_host.sh"
																style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("scripts.adbyby_host.sh",""); %></textarea>
														</div>
													</td>
												</tr>
											</table>
											<table width="100%" align="center" cellpadding="4" cellspacing="0"
												...
												<tr>
													...
													<td colspan="2" width="50%">
														...
														<input type="checkbox" id="adbyby_ip_x_fake"
															<% nvram_match_x( "", "adbyby_ip_x", "1", "value=1 checked"); %>
															<% nvram_match_x("", "adbyby_ip_x", "0", "value=0"); %>>
														<div style="position: absolute; margin-left: -10000px;">
															<input type="radio" value="1" name="adbyby_ip_x"
																id="adbyby_ip_x_1" onclick="change_adbyby_ip_enabled()" <% nvram_match_x(
														 "", "adbyby_ip_x", "1", "checked"); %> />
															<#checkbox_Yes#>
																<input type="radio" value="0" name="adbyby_ip_x"
																	id="adbyby_ip_x_0"
																	onclick="change_adbyby_ip_enabled()" <% nvram_match_x(
															 "", "adbyby_ip_x", "0", "checked"); %> />
																<#checkbox_No#>
														</div>
													</td>
												</tr>
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0"
												...
												<tr id="row_static_caption" style="display:none">
													...
													<th width="20%">
														过滤模式 <a href="javascript:sortbyName();" style="outline:0;"><i
																class="if if-th-sort"></i></a>
													</th>
													<th width="5%">
														<center><a href="javascript:sortbyId();" style="outline:0;"><i
																	class="if if-th-list"></i></a></center>
													</th>
												</tr>
												<tr id="row_static_header" style="display:none">
													<td width="25%">
														...
														<div class="input-append">
															<input type="text" maxlength="12" class="span12" size="12"
																name="adbybyip_mac_x_0"
																value="<% nvram_get_x("", "adbybyip_mac_x_0"); %>"
													...
													<td width="25%">
														<input type="text" maxlength="15" class="span12" size="15"
															name="adbybyip_ip_x_0"
															value="<% nvram_get_x("", "adbybyip_ip_x_0"); %>"
															onkeypress="return is_ipaddr(this,event);" />
													</td>
													<td width="25%">
														<input type="text" maxlength="24" class="span12" size="20"
															name="adbybyip_name_x_0"
															value="<% nvram_get_x("", "adbybyip_name_x_0"); %>"
															onKeyPress="return is_string(this,event);" />
													</td>
													<td width="20%">
														<select name="adbybyip_ip_road_x_0" class="input"
															style="width: 110px">
															<option value="0"
																<% nvram_match_x("","adbybyip_ip_road_x_0", "0","selected"); %>>
																直连模式</option>
															<option value="1"
																<% nvram_match_x("","adbybyip_ip_road_x_0", "1","selected"); %>>
																全局模式</option>
															<option value="2"
																<% nvram_match_x("","adbybyip_ip_road_x_0", "2","selected"); %>>
																plus+模式</option>
														</select>
													</td>
													<td width="5%">
											...
											<table width="100%" align="center" cellpadding="5" cellspacing="0"
												...
												<tr>
													...
													<td width="50%">
														...
														<input type="checkbox" id="adbyby_rules_x_fake"
															<% nvram_match_x( "", "adbyby_rules_x", "1", "value=1 checked"); %>
															<% nvram_match_x("", "adbyby_rules_x", "0", "value=0"); %>>

														<div style="position: absolute; margin-left: -10000px;">
															<input type="radio" value="1" name="adbyby_rules_x"
																id="adbyby_rules_x_1"
																onclick="change_adbyby_rules_enabled()" <% nvram_match_x(
														 "", "adbyby_rules_x", "1", "checked"); %> />
															<#checkbox_Yes#>
																<input type="radio" value="0" name="adbyby_rules_x"
																	id="adbyby_rules_x_0"
																	onclick="change_adbyby_rules_enabled()" <% nvram_match_x(
											...
											<table width="100%" align="center" cellpadding="3" cellspacing="0"
												...
												<tr id="row_rules_caption" style="display:none">
													...
													<th width="85%">
														规则地址 <i class="if if-th-sort"></i>
													</th>
													<th width="10%">
														状态 <i class="if if-th-sort"></i>
													</th>
													<th width="5%">
														<center><i class="if if-th-list"></i></center>
													</th>
												</tr>
												<tr id="row_rules_header" style="display:none">
													<td width="85%">
														<input type="text" maxlength="255" class="span12" size="200"
															name="adbybyrules_x_0"
															value="<% nvram_get_x("", "adbybyrules_x_0"); %>"
															onKeyPress="return is_string(this,event);" />
													</td>
													<td width="10%">
														<select name="adbybyrules_road_x_0" class="input"
															style="width: 65px">
															<option value="0"
																<% nvram_match_x("","adbybyrules_road_x_0", "0","selected"); %>>
																禁用</option>
															<option value="1"
																<% nvram_match_x("","adbybyrules_road_x_0", "1","selected"); %>>
																启用</option>
														</select>
													</td>
													<td width="5%">
														<center> <button class="btn" style="max-width: 219px "
																type="submit"
																onclick="return markGroupRULES(this, 64, ' Add ');"
																name="ManualRULESList2" value="<#CTL_add#>" size="12"><i
																	class="if if-btn-plus"></i></button></center>
													</td>
												</tr>
											...
											<table class="table">
												<tr>
													<td colspan="3">
														<i class="if if-tip-hand-right"></i> <a
															href="javascript:spoiler_toggle('script9')"><span>Plus+
																模式过滤的域名:</span></a>
														<div id="script9">
															<textarea rows="8" wrap="off" spellcheck="false"
																maxlength="314571" class="span12"
																name="scripts.adbyby_adhost.sh"
																style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("scripts.adbyby_adhost.sh",""); %></textarea>
														</div>
													</td>
												</tr>
												<tr>
													<td colspan="3" style="border-top: 0 none;">
														<i class="if if-tip-hand-right"></i> <a
															href="javascript:spoiler_toggle('script10')"><span>域名白名单:</span></a>
														<div id="script10" style="display:none;">
															<textarea rows="24" wrap="off" spellcheck="false"
																maxlength="314571" class="span12"
																name="scripts.adbyby_adesc.sh"
																style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("scripts.adbyby_adesc.sh",""); %></textarea>
														</div>
													</td>
												</tr>
												<tr>
													<td colspan="3" style="border-top: 0 none;">
														<i class="if if-tip-hand-right"></i> <a
															href="javascript:spoiler_toggle('script11')"><span>IP黑名单:</span></a>
														<div id="script11" style="display:none;">
															<textarea rows="24" wrap="off" spellcheck="false"
																maxlength="314571" class="span12"
																name="scripts.adbyby_blockip.sh"
																style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("scripts.adbyby_blockip.sh",""); %></textarea>
														</div>
													</td>
												</tr>
												<tr>
													<td colspan="3" style="border-top: 0 none;">
														<i class="if if-tip-hand-right"></i> <a
															href="javascript:spoiler_toggle('script12')"><span>域名黑名单:</span></a>
														<div id="script12" style="display:none;">
															<textarea rows="24" wrap="off" spellcheck="false"
																maxlength="314571" class="span12"
																name="scripts.adbyby_adblack.sh"
																style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("scripts.adbyby_adblack.sh",""); %></textarea>
														</div>
													</td>
												</tr>
												<tr>
													<td colspan="3" style="border-top: 0 none;">
														<i class="if if-tip-hand-right"></i> <a
															href="javascript:spoiler_toggle('script13')"><span>用户自定义规则:</span></a>
														<div id="script13" style="display:none;">
															<textarea rows="8" wrap="off" spellcheck="false"
																maxlength="314571" class="span12"
																name="scripts.adbyby_rules.sh"
																style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("scripts.adbyby_rules.sh",""); %></textarea>
														</div>
													</td>
												</tr>
