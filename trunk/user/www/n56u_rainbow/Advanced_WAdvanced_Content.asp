                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                                ...
                                                <tr id="row_greenap">
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="wl_greenap_fake" <% nvram_match_x( "", "wl_greenap", "1", "value=1 checked"); %>
                                                        <% nvram_match_x("", "wl_greenap", "0", "value=0"); %>>

                                                            <div style="position: absolute; margin-left: -10000px;">
                                                                <input type="radio" value="1" name="wl_greenap" id="wl_greenap_1" class="input" <% nvram_match_x( "", "wl_greenap", "1",
                                                                    "checked"); %>>
                                                                <#checkbox_Yes#>
                                                                    <input type="radio" value="0" name="wl_greenap" id="wl_greenap_0" class="input" <% nvram_match_x( "", "wl_greenap", "0",
                                                                        "checked"); %>>
                                                                    <#checkbox_No#>
                                                            </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="wl_ap_isolate_fake" <% nvram_match_x( "", "wl_ap_isolate", "1", "value=1 checked"); %>
                                                        <% nvram_match_x("","wl_ap_isolate", "0", "value=0"); %>>

                                                            <div style="position: absolute; margin-left: -10000px;">
                                                                <input type="radio" name="wl_ap_isolate" id="wl_ap_isolate_1" value="1" <% nvram_match_x( "", "wl_ap_isolate", "1",
                                                                    "checked"); %>>
                                                                <#checkbox_Yes#>
                                                                    <input type="radio" name="wl_ap_isolate" id="wl_ap_isolate_0" value="0" <% nvram_match_x( "", "wl_ap_isolate", "0",
                                                                        "checked"); %>>
                                                                    <#checkbox_No#>
                                                            </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="4" size="5" name="wl_frag" class="input" value="<% nvram_get_x(" ", "wl_frag "); %>" onKeyPress="return is_number(this,event);"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="3" size="5" name="wl_dtim" class="input" value="<% nvram_get_x(" ", "wl_dtim "); %>" onKeyPress="return is_number(this,event);"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="4" size="5" name="wl_bcn" class="input" value="<% nvram_get_x(" ", "wl_bcn "); %>" onKeyPress="return is_number(this,event);"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="wl_PktAggregate" class="input" onChange="return change_common_wl(this, 'WLANConfig11a', 'wl_PktAggregate')">
                                                            <option value="0" <% nvram_match_x( "", "wl_PktAggregate", "0", "selected"); %>>
                                                                <#btn_Disable#>
                                                            </option>
                                                            <option value="1" <% nvram_match_x( "", "wl_PktAggregate", "1", "selected"); %>>
                                                                <#btn_Enable#> (*)</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="wl_HT_AutoBA" class="input">
                                                            <option value="0" <% nvram_match_x( "", "wl_HT_AutoBA", "0", "selected"); %>>
                                                                <#btn_Disable#>
                                                            </option>
                                                            <option value="1" <% nvram_match_x( "", "wl_HT_AutoBA", "1", "selected"); %>>
                                                                <#btn_Enable#> (*)</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr id="row_greenfield">
                                                    ...
                                                    <td>
                                                        <select class="input" id="wl_HT_OpMode" name="wl_HT_OpMode" onChange="return change_common_wl(this, 'WLANConfig11a', 'wl_HT_OpMode')">
                                                            <option value="0" <% nvram_match_x( "", "wl_HT_OpMode", "0", "selected"); %>>
                                                                <#btn_Disable#> (*)</option>
                                                            <option value="1" <% nvram_match_x( "", "wl_HT_OpMode", "1", "selected"); %>>
                                                                <#btn_Enable#>
                                                            </option>
                                                        </select>
                                                    </td>
                                                ...
                                                <tr id="row_wme_no_ack">
                                                    ...
                                                    <td>
                                                        <select name="wl_wme_no_ack" id="wl_wme_no_ack" class="input" onChange="return change_common_wl(this, 'WLANConfig11a', 'wl_wme_no_ack')">
                                                            <option value="off" <% nvram_match_x( "", "wl_wme_no_ack", "off", "selected"); %>>
                                                                <#btn_Disable#> (*)</option>
                                                            <option value="on" <% nvram_match_x( "", "wl_wme_no_ack", "on", "selected"); %>>
                                                                <#btn_Enable#>
                                                            </option>
                                                        </select>
                                                    </td>
                                                ...
                                                <tr id="row_apsd_cap">
                                                    ...
                                                    <td>
                                                        <select name="wl_APSDCapable" class="input" onchange="return change_common_wl(this, 'WLANConfig11a', 'wl_APSDCapable')">
                                                            <option value="0" <% nvram_match_x( "", "wl_APSDCapable", "0", "selected"); %> >
                                                                <#btn_Disable#>
                                                            </option>
                                                            <option value="1" <% nvram_match_x( "", "wl_APSDCapable", "1", "selected"); %> >
                                                                <#btn_Enable#> (*)</option>
                                                        </select>
                                                    </td>
                                                </tr>
