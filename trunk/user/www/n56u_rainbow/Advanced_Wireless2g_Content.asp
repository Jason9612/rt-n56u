                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                                    ...
                                                    <td style="border-top: 0 none;">
                                                        ...
                                                        <% nvram_match_x("","rt_radio_x", "0", "value=0"); %>>
                                                            ...
                                                            <div style="position: absolute; margin-left: -10000px;">
                                                                <input type="radio" value="1" id="rt_radio_x_1" name="rt_radio_x" class="input" <% nvram_match_x( "", "rt_radio_x", "1",
                                                                    "checked"); %>/>
                                                                <#checkbox_Yes#>
                                                                    <input type="radio" value="0" id="rt_radio_x_0" name="rt_radio_x" class="input" <% nvram_match_x( "", "rt_radio_x", "0",
                                                                        "checked"); %>/>
                                                                    <#checkbox_No#>
                                                            </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="controls">
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="rt_radio_date_x_Mon"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Mon#>
                                                            </label>
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="rt_radio_date_x_Tue"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Tue#>
                                                            </label>
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="rt_radio_date_x_Wed"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Wed#>
                                                            </label>
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="rt_radio_date_x_Thu"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Thu#>
                                                            </label>
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="rt_radio_date_x_Fri"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Fri#>
                                                            </label>
                                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="controls">
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="rt_radio_date_x_Sat"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Sat#>
                                                            </label>
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="rt_radio_date_x_Sun"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Sun#>
                                                            </label>
                                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <% nvram_match_x("", "rt_closed", "0", "value=0"); %>>
                                                            ...
                                                            <div style="position: absolute; margin-left: -10000px;">
                                                                <input type="radio" value="1" id="rt_closed_1" name="rt_closed" <% nvram_match_x( "", "rt_closed", "1", "checked"); %>>
                                                                <#checkbox_Yes#>
                                                                    <input type="radio" value="0" id="rt_closed_0" name="rt_closed" <% nvram_match_x( "", "rt_closed", "0", "checked"); %>>
                                                                    <#checkbox_No#>
                                                            </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr id="row_wpa3">
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="7" size="7" name="rt_wpa_gtk_rekey" class="input" value="<% nvram_get_x(" ", "rt_wpa_gtk_rekey
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="3" size="3" name="rt_TxPower" class="input" value="<% nvram_get_x(" ", "rt_TxPower "); %>"
                                                            onKeyPress="return is_number(this,event);" onblur="return validate_range(this, 0, 100);"
                                                        /> &nbsp;
