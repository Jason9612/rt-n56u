...
var ipmonitor = [<% get_static_client(); %>];
		...
		function initial() {
			show_banner(2);
			show_menu('if-m1-syssettings', 'if-m2-unlockmusic', 0);
		...
		*/
		...
		function showMDHCPList() {
			...
			if (m_dhcp.length == 0)
				...
				code += '<td><button class="btn btn-danger" type="submit" onclick="markGroupMDHCP(this, 64, \' Del \');" name="WIPList"><i class="if if-btn-minus"></i></button></td>';
				code += '</tr>';
			}
			code += '</table>';
									...
									<div class="round_bottom">
										<div class="row-fluid">
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
												<tr>
													...
													<td style="border-top: 0 none;">
														...
														<input type="checkbox" id="wyy_enable_fake" <% nvram_match_x( "", "wyy_enable", "1", "value=1 checked"); %>
														<% nvram_match_x("", "wyy_enable", "0", "value=0"); %> />

															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" value="1" name="wyy_enable" id="wyy_enable_1" class="input" value="1" <% nvram_match_x( "",
																 "wyy_enable", "1", "checked"); %> />
																<#checkbox_Yes#>
																	<input type="radio" value="0" name="wyy_enable" id="wyy_enable_0" class="input" value="0" <% nvram_match_x( "",
																	 "wyy_enable", "0", "checked"); %> />
																	<#checkbox_No#>
															</div>
												...
												<tr id="row_wyy_cloudserver" style="display:none;">
													...
													<td>
														...
														<br> 自定义服务器格式为 IP[域名]:HTTP端口:HTTPS端口 如果服务器为LAN内网IP，需要将这个服务器IP放入例外客户端 (不代理HTTP和HTTPS)
													</td>
											...
											<option value="coustom">-- 自定义 --</option>
												...
												<tr id="row_wyy_coustom_server" style="display:none;">
													<th>自定义服务器</th>
													<td>
...
目前仅支持酷我、QQ、咪咕
												...
												<tr>
													<th>HTTPS 证书</th>
													<td>
														<input type="button" class="btn btn-success" value="下载CA根证书" onclick="window.open('https://raw.githubusercontent.com/nondanee/UnblockNeteaseMusic/master/ca.crt')"
														 size="0">
														<br>Mac/iOS客户端需要安装 CA根证书并信任
														<br>iOS系统需要在“设置 -&gt; 通用 -&gt; 关于本机 -&gt; 证书信任设置”中，信任 UnblockNeteaseMusic Root CA
														<br>Linux 设备请在启用时加入 --ignore-certificate-errors 参数
													</td>
												</tr>
												<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
													<tr>
													...
													<tr>
														<td width="25%">
															...
															<div class="input-append">
																<input type="text" maxlength="12" class="span12" size="12" name="wyy_mac_x_0" value="" onkeypress="return is_hwaddr(event);"
