                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                                ...
                                                <tr id="row_mroute">
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="mr_enable_x_fake" <% nvram_match_x( "", "mr_enable_x", "1", "value=1 checked"); %>
                                                        <% nvram_match_x("", "mr_enable_x", "0", "value=0"); %> />


                                                            <div style="position: absolute; margin-left: -10000px;">
                                                                <input type="radio" value="1" name="mr_enable_x" id="mr_enable_x_1" class="input" onclick="on_click_mroute();" <% nvram_match_x(
                                                                    "", "mr_enable_x", "1", "checked"); %> />
                                                                <#checkbox_Yes#>
                                                                    <input type="radio" value="0" name="mr_enable_x" id="mr_enable_x_0" class="input" onclick="on_click_mroute();" <% nvram_match_x(
                                                                        "", "mr_enable_x", "0", "checked"); %> />
                                                                    <#checkbox_No#>
                                                            </div>
                                                    </td>
                                                </tr>
                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                                ...
                                                <tr>
                                                    <th width="50%">
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,6, 6);">
                                                            <#RouterConfig_IPTV_itemname#>:</a>
                                                    </th>
                                                    <td>
                                                        <input type="text" maxlength="5" class="input" size="15" name="udpxy_enable_x" value="<% nvram_get_x(" ", "udpxy_enable_x
                                                            "); %>" onkeypress="return is_number(this,event);" onblur="valid_udpxy();"
                                                        />
                                                    </td>
                                                    <td width="15%">
                                                ...
                                                <tr id="row_xupnpd">
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="5" class="input" size="15" name="xupnpd_enable_x" value="<% nvram_get_x(" ", "xupnpd_enable_x
                                                            "); %>" onkeypress="return is_number(this,event);" onblur="valid_xupnpd();"
                                                        />
                                                    </td>
                                                    <td width="15%">
                                                ...
                                                <tr id="row_xupnpd_udpxy" style="display:none;">
                                                    ...
                                                    <td colspan="2">
                                                        <select name="xupnpd_udpxy" class="input">
                                                            <option value="0" <% nvram_match_x( "", "xupnpd_udpxy", "0", "selected"); %>>
                                                                <#checkbox_No#>
                                                            </option>
                                                            <option value="1" <% nvram_match_x( "", "xupnpd_udpxy", "1", "selected"); %>>
                                                                <#checkbox_Yes#>
                                                            </option>
                                                        </select>
                                                    </td>
                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                                <tr>
                                                    <th colspan="2" style="background-color: #E3E3E3;">
                                                        <#IPTVMulticast#> - IGMP/MLD Snooping</th>
                                                </tr>
                                                <tr>
                                                    <th width="50%">
                                                        <#SwitchIgmp#>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="ether_igmp_fake" <% nvram_match_x( "", "ether_igmp", "1", "value=1 checked"); %>
                                                        <% nvram_match_x("", "ether_igmp", "0", "value=0"); %> />


                                                            <div style="position: absolute; margin-left: -10000px;">
                                                                <input type="radio" value="1" name="ether_igmp" id="ether_igmp_1" class="input" onclick="on_click_snoop();" <% nvram_match_x(
                                                                    "", "ether_igmp", "1", "checked"); %> />
                                                                <#checkbox_Yes#>
                                                                    <input type="radio" value="0" name="ether_igmp" id="ether_igmp_0" class="input" onclick="on_click_snoop();" <% nvram_match_x(
                                                                        "", "ether_igmp", "0", "checked"); %> />
                                                                    <#checkbox_No#>
                                                            </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr id="row_m2u_2ghz">
                                                    ...
                                                    <td>
                                                        <select name="rt_IgmpSnEnable" class="input">
                                                            <option value="0" <% nvram_match_x( "", "rt_IgmpSnEnable", "0", "selected"); %>>
                                                                <#btn_Disable#>
                                                            </option>
                                                ...
                                                <tr id="row_m2u_5ghz">
                                                    ...
                                                    <td>
                                                        <select name="wl_IgmpSnEnable" class="input">
                                                            <option value="0" <% nvram_match_x( "", "wl_IgmpSnEnable", "0", "selected"); %>>
                                                                <#btn_Disable#>
                                                            </option>
                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                                ...
                                                <tr id="row_storm_ucast">
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="4" class="input" size="15" name="controlrate_unknown_unicast" value="<% nvram_get_x(" ", "controlrate_unknown_unicast
                                                ...
                                                <tr id="row_storm_mcast_unk">
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="4" class="input" size="15" name="controlrate_unknown_multicast" value="<% nvram_get_x("
                                                            ", "controlrate_unknown_multicast "); %>" onkeypress="return is_number(this,event);"
                                                        /> &nbsp;
                                                ...
                                                <tr id="row_storm_mcast">
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="4" class="input" size="15" name="controlrate_multicast" value="<% nvram_get_x(" ", "controlrate_multicast
                                                            "); %>" onkeypress="return is_number(this,event);" /> &nbsp;
                                                        <span style="color:#888;">[0..1000]</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="4" class="input" size="15" name="controlrate_broadcast" value="<% nvram_get_x(" ", "controlrate_broadcast
                                                            "); %>" onkeypress="return is_number(this,event);" /> &nbsp;
