                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="ez_action_short" class="input">
                                                            ...
                                                            <option value="2">
                                                                <#TweaksWPSItem02#> 2.4</option>
                                                            <option value="3">
                                                                <#TweaksWPSItem02#> 5</option>
                                                            <option value="4">
                                                                <#TweaksWPSItem02#> 2.4 & 5</option>
                                                            <option value="11">
                                                                <#TweaksWPSItem03#> 2.4</option>
                                                            <option value="12">
                                                                <#TweaksWPSItem03#> 5</option>
                                                            <option value="13">
                                                                <#TweaksWPSItem03#> 2.4 & 5</option>
                                                            <option value="5">
                                                                <#TweaksWPSItem10#>
                                                            </option>
                                                            <option value="21">
                                            ...
                                            <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="front_led_all_fake" <% nvram_match_x( "", "front_led_all", "1", "value=1 checked"); %>
                                                        <% nvram_match_x("", "front_led_all", "0", "value=0"); %>>


                                                            <div style="position: absolute; margin-left: -10000px;">
                                                                <input type="radio" value="1" name="front_led_all" id="front_led_all_1" class="input" onclick="change_led_all();" <% nvram_match_x(
                                                                    "", "front_led_all", "1", "checked"); %> />
                                                                <#checkbox_Yes#>
                                                                    <input type="radio" value="0" name="front_led_all" id="front_led_all_0" class="input" onclick="change_led_all();" <% nvram_match_x(
                                                ...
                                                <tr id="row_led_wan">
                                                    ...
                                                    <td>
                                                        <select name="front_led_wan" class="input">
                                                            <option value="0" <% nvram_match_x( "", "front_led_wan", "0", "selected"); %>>
                                                                <#btn_Disable#>
                                                            </option>
                                                            <option value="1" <% nvram_match_x( "", "front_led_wan", "1", "selected"); %>>
                                                                <#TweaksLEDItem00#>
                                                            </option>
                                                            <option value="2" <% nvram_match_x( "", "front_led_wan", "2", "selected"); %>>
                                                                <#TweaksLEDItem03#> (*)</option>
                                                            <option value="3" <% nvram_match_x( "", "front_led_wan", "3", "selected"); %>>
                                                                <#TweaksLEDItem04#>
                                                            </option>
                                                        </select>
                                                    </td>
                                                ...
                                                <tr id="row_led_lan" style="display:none;">
                                                    ...
                                                    <td>
                                                        <select name="front_led_lan" class="input">
                                                            <option value="0" <% nvram_match_x( "", "front_led_lan", "0", "selected"); %>>
                                                                <#btn_Disable#>
                                                            </option>
                                                            <option value="1" <% nvram_match_x( "", "front_led_lan", "1", "selected"); %>>
                                                                <#TweaksLEDItem00#> (*)</option>
                                                            <option value="2" <% nvram_match_x( "", "front_led_lan", "2", "selected"); %>>
                                                                <#TweaksLEDItem01#>
                                                            </option>
                                                            <option value="3" <% nvram_match_x( "", "front_led_lan", "3", "selected"); %>>
                                                                <#TweaksLEDItem02#>
                                                            </option>
                                                        </select>
                                                    </td>
                                                ...
                                                <tr id="row_led_usb" style="display:none;">
                                                    ...
                                                    <td>
                                                        <select name="front_led_usb" class="input">
                                                            <option value="0" <% nvram_match_x( "", "front_led_usb", "0", "selected"); %>>
                                                                <#btn_Disable#>
                                                            </option>
                                                            <option value="1" <% nvram_match_x( "", "front_led_usb", "1", "selected"); %>>
                                                                <#TweaksLEDItem05#> (*)</option>
                                                            <option value="2" <% nvram_match_x( "", "front_led_usb", "2", "selected"); %>>
                                                                <#TweaksLEDItem06#>
                                                            </option>
                                                            <option value="3" <% nvram_match_x( "", "front_led_usb", "3", "selected"); %>>
                                                                <#TweaksLEDItem07#>
                                                            </option>
                                                        </select>
                                                    </td>
                                                ...
                                                <tr id="row_led_wif" style="display:none;">
                                                    ...
                                                    <td>
                                                        <select name="front_led_wif" class="input">
                                                            <option value="0" <% nvram_match_x( "", "front_led_wif", "0", "selected"); %>>
                                                                <#btn_Disable#>
                                                            </option>
                                                            <option value="1" <% nvram_match_x( "", "front_led_wif", "1", "selected"); %>>
                                                                <#TweaksLEDItem09#> (*)</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                <tr id="row_led_pwr">
                                                    ...
                                                    <td>
                                                        <select name="front_led_pwr" class="input">
                                                            <option value="0" <% nvram_match_x( "", "front_led_pwr", "0", "selected"); %>>
                                                                <#btn_Disable#>,
                                                                    <#TweaksLEDItem11#>
                                                            </option>
                                                            <option value="1" <% nvram_match_x( "", "front_led_pwr", "1", "selected"); %>>
                                                                <#btn_Enable#>,
                                                                    <#TweaksLEDItem11#> (*)</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                <tr id="row_eth_phy_led0">
                                                    ...
                                                    <td>
                                                        <select name="ether_led0" class="input">
                                                            ...
                                                            <option value="11" <% nvram_match_x( "", "ether_led0", "11", "selected"); %>>
                                                                <#btn_Disable#>
                                                            </option>
                                                        </select>
                                                    </td>
                                                ...
                                                <tr id="row_eth_phy_led1">
                                                    ...
                                                    <td>
                                                        <select name="ether_led1" class="input">
                                                            ...
                                                            <option value="11" <% nvram_match_x( "", "ether_led1", "11", "selected"); %>>
                                                                <#btn_Disable#>
                                                            </option>
                                                        </select>
                                                    </td>
