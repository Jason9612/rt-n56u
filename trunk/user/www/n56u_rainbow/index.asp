	...
	<div class="wrapper">
		<noscript>
			<div class="popup_bg" style="visibility:visible; z-index:999;">
				<div
					style="margin:200px auto; width:300px; background-color:#006699; color:#FFFFFF; line-height:150%; border:3px solid #FFF; padding:5px;">
					<#not_support_script#>
						</p>
				</div>
			</div>
									...
									<tbody>
										<tr id="row_internet">
											<td width="30%">
												<a id="linkInternet" href="/device-map/internet.asp" target="statusframe" style="outline:0;">
													<i id="iconInternet" class="if if-shortcut-internet" onclick="clickEvent(this);"></i>
												</a>
										...
										<tr>
											<td>
												...
												<div class="badge-container">												
													<div id="clientNumber" class="badge badge-circle">&nbsp;</div>
												</div>
