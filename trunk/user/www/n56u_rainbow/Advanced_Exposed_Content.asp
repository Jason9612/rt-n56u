                                ...
                                <div class="row-fluid">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="input-append">
                                                    ...
                                                    <button class="btn btn-chevron" id="chevron" type="button" onclick="pullLANIPList(this);" title="Select the IP of LAN clients."><i class="if if-btn-down"></i></button>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="checkbox" id="sp_battle_ips_fake" <% nvram_match_x( "", "sp_battle_ips", "1", "value=1 checked"); %>
                                                <% nvram_match_x("", "sp_battle_ips", "0", "value=0"); %> />
                                                    <div style="position: absolute; margin-left: -10000px;">
                                                        <input type="radio" value="1" name="sp_battle_ips" id="sp_battle_ips_1" <% nvram_match_x( "", "sp_battle_ips", "1",
                                                            "checked"); %>/>
                                                        <#checkbox_Yes#>
                                                            <input type="radio" value="0" name="sp_battle_ips" id="sp_battle_ips_0" <% nvram_match_x( "", "sp_battle_ips", "0",
                                                                "checked"); %>/>
                                                            <#checkbox_No#>
                                                    </div>
                                            </td>
