									...
									<div class="round_bottom">
										...
										<div class="row-fluid">
											...
											<div class="alert alert-info" style="margin: 10px;">
												<p>AdGuard Home
													是一款全网广告拦截与反跟踪软件。在您将其安装完毕后，它将保护您所有家用设备，同时您不再需要安装任何客户端软件。随着物联网与连接设备的兴起，掌控您自己的整个网络环境变得越来越重要。
												</p>
												...
												<tr>
													...
													<td style="border-top: 0 none;">
														<input type="checkbox" id="adg_enable_fake"
															<% nvram_match_x( "", "adg_enable", "1", "value=1 checked"); %>
															<% nvram_match_x("", "adg_enable", "0", "value=0"); %> />

														<div style="position: absolute; margin-left: -10000px;">
															<input type="radio" value="1" name="adg_enable"
																id="adg_enable_1" class="input" value="1" <% nvram_match_x( "",
														 "adg_enable", "1", "checked"); %> />
															<#checkbox_Yes#>
																<input type="radio" value="0" name="adg_enable"
																	id="adg_enable_0" class="input" value="0" <% nvram_match_x( "",
															 "adg_enable", "0", "checked"); %> />
																<#checkbox_No#>
														</div>
													</td>
												</tr>
												...
												<tr>
													...
													<td>
														<select name="adg_redirect" class="input" style="width: 200px">
															<option value="0"
																<% nvram_match_x("","adg_redirect", "0","selected"); %>>
																无</option>
															<option value="1"
																<% nvram_match_x("","adg_redirect", "1","selected"); %>>
																作为dnsmasq的上游服务器</option>
															<option value="2"
																<% nvram_match_x("","adg_redirect", "2","selected"); %>>
																重定向53端口到AdGuardHome</option>
														</select>
													</td>
												</tr>
												<tr>
													...
													<td>
														<a
															href="http://<% nvram_get_x("", "lan_ipaddr"); %>:3030">http://<% nvram_get_x("", "lan_ipaddr"); %>:3030</a>
													</td>
												</tr>
