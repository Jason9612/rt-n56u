                                ...
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" name="commit_nvram" id="commit_nvram" class="btn" style="width: 219px; outline: 0"><#CTL_Commit#></button>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <button type="button" name="commit_storage" id="commit_storage" class="btn" style="width: 219px; outline: 0"><#CTL_Commit#></button>
                                            </td>
                                        </tr>
                                    </table>
