                                ...
                                <div class="row-fluid">
                                    ...
                                    <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="checkbox" id="dr_enable_x_fake" <% nvram_match_x( "", "dr_enable_x", "1", "value=1 checked"); %>
                                                <% nvram_match_x("", "dr_enable_x", "0", "value=0"); %>>
                                        
                                                    <div style="position: absolute; margin-left: -10000px;">
                                                        <input type="radio" value="1" name="dr_enable_x" id="dr_enable_x_1" class="input" <% nvram_match_x( "", "dr_enable_x",
                                                            "1", "checked"); %>>
                                                        <#checkbox_Yes#>
                                                            <input type="radio" value="0" name="dr_enable_x" id="dr_enable_x_0" class="input" <% nvram_match_x( "", "dr_enable_x",
                                                                "0", "checked"); %>>
                                                            <#checkbox_No#>
                                                    </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="checkbox" id="sr_enable_x_fake" <% nvram_match_x( "", "sr_enable_x", "1", "value=1 checked"); %>
                                                <% nvram_match_x("", "sr_enable_x", "0", "value=0"); %>>
                                        
                                                    <div style="position: absolute; margin-left: -10000px;">
                                                        <input type="radio" value="1" name="sr_enable_x" id="sr_enable_x_1" class="input" onclick="change_sr_enabled();" <% nvram_match_x(
                                                            "", "sr_enable_x", "1", "checked"); %>>
                                                        <#checkbox_Yes#>
                                                            <input type="radio" value="0" name="sr_enable_x" id="sr_enable_x_0" class="input" onclick="change_sr_enabled();" <% nvram_match_x(
                                                                "", "sr_enable_x", "0", "checked"); %>>
                                                            <#checkbox_No#>
                                                    </div>
                                            </td>
                                        </tr>
                                    ...
                                    <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table table-list" id="GWStaticList_Block">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn" type="submit" onClick="return GWStatic_markGroup(this, 64, ' Add ');" name="GWStatic2"><i class="if if-btn-plus"></i></button>
                                            </td>
                                        </tr>
                                    </table>
