                                    ...
                                    <div class="round_bottom">
                                        <div class="row-fluid">
                                            ...
                                            <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                                <tr>
                                                    <th width="50%" style="padding-bottom: 0px; border-top: 0 none;">
                                                        <#FirewallConfig_UrlFilterEnable_itemname#>?</th>
                                                    <td style="padding-bottom: 0px; border-top: 0 none;">

                                                        <input type="checkbox" id="url_enable_fake" <% nvram_match_x( "", "url_enable_x", "1", "value=1 checked"); %>
                                                        <% nvram_match_x("", "url_enable_x", "0", "value=0"); %>>

                                                            <div style="position: absolute; margin-left: -10000px;">
                                                                <input type="radio" value="1" name="url_enable_x" id="url_enable_1" onClick="change_url_enable();" <% nvram_match_x( "",
                                                                    "url_enable_x", "1", "checked"); %>>
                                                                <#CTL_Enabled#>
                                                                    <input type="radio" value="0" name="url_enable_x" id="url_enable_0" onClick="change_url_enable();" <% nvram_match_x( "",
                                                                        "url_enable_x", "0", "checked"); %>>
                                                                    <#CTL_Disabled#>
                                                            </div>
                                                    </td>
                                                </tr>
                                            ...
                                            <table width="100%" cellpadding="4" cellspacing="0" class="table" id="tbl_urlf_main" style="display:none">
                                                ...
                                                <tr>
                                                    <th>
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,9,2);">
                                                            <#FirewallConfig_URLActiveTime_itemname#>:</a>
                                                    </th>
                                                    <td colspan="2">
                                                ...
                                                <tr>
                                                    <th>
                                                        <#FirewallConfig_UrlMAC#>:</th>
                                                    <td colspan="2" align="left">
                                                        <div id="ClientList_Block" class="alert alert-info ddown-list"></div>
                                                        <div class="input-append">
                                                            <input type="text" maxlength="12" class="span12" size="15" name="url_mac_x" value="<% nvram_get_x(" ","url_mac_x "); %>"
                                                                onKeyPress="return is_hwaddr(event);" style="float:left; width: 162px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding-right: 0px;">
                                                        <input type="text" class="span12" maxlength="96" size="36" name="url_keyword_x_0" value="<% nvram_get_x(" ", "url_keyword_x_0
