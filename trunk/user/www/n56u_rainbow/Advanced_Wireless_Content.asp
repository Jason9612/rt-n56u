                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                                    ...
                                                    <td style="border-top: 0 none;">
                                                        ...
                                                        <% nvram_match_x("","wl_radio_x", "0", "value=0"); %>>
                                                            ...
                                                            <div style="position: absolute; margin-left: -10000px;">
                                                                <input type="radio" name="wl_radio_x" id="wl_radio_x_1" value="1" <% nvram_match_x( "", "wl_radio_x", "1", "checked"); %> />
                                                                <#checkbox_Yes#>
                                                                    <input type="radio" name="wl_radio_x" id="wl_radio_x_0" value="0" <% nvram_match_x( "", "wl_radio_x", "0", "checked"); %> />
                                                                    <#checkbox_No#>
                                                            </div>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td>
                                                        <div class="controls">
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="wl_radio_date_x_Mon"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Mon#>
                                                            </label>
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="wl_radio_date_x_Tue"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Tue#>
                                                            </label>
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="wl_radio_date_x_Wed"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Wed#>
                                                            </label>
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="wl_radio_date_x_Thu"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Thu#>
                                                            </label>
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="wl_radio_date_x_Fri"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Fri#>
                                                            </label>
                                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="controls">
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="wl_radio_date_x_Sat"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Sat#>
                                                            </label>
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="wl_radio_date_x_Sun"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Sun#>
                                                            </label>
                                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <% nvram_match_x("", "wl_closed", "0", "value=0"); %>>
                                                            ...
                                                            <div style="position: absolute; margin-left: -10000px;">
                                                                <input type="radio" value="1" id="wl_closed_1" name="wl_closed" <% nvram_match_x( "", "wl_closed", "1", "checked"); %> />
                                                                <#checkbox_Yes#>
                                                                    <input type="radio" value="0" id="wl_closed_0" name="wl_closed" <% nvram_match_x( "", "wl_closed", "0", "checked"); %> />
                                                                    <#checkbox_No#>
                                                            </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr id="row_wpa3">
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="7" size="7" name="wl_wpa_gtk_rekey" class="input" value="<% nvram_get_x(" ", "wl_wpa_gtk_rekey
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="3" size="3" name="wl_TxPower" class="input" value="<% nvram_get_x(" ", "wl_TxPower "); %>"
