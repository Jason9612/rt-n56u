                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                                ...
                                                <tr id="row_greenap">
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="rt_greenap_fake" <% nvram_match_x( "", "rt_greenap", "1", "value=1 checked"); %>
                                                        <% nvram_match_x("", "rt_greenap", "0", "value=0"); %>>


                                                            <div style="position: absolute; margin-left: -10000px;">
                                                                <input type="radio" value="1" name="rt_greenap" id="rt_greenap_1" class="input" <% nvram_match_x( "", "rt_greenap", "1",
                                                                    "checked"); %>>
                                                                <#checkbox_Yes#>
                                                                    <input type="radio" value="0" name="rt_greenap" id="rt_greenap_0" class="input" <% nvram_match_x( "", "rt_greenap", "0",
                                                                        "checked"); %>>
                                                                    <#checkbox_No#>
                                                            </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="rt_ap_isolate_fake" <% nvram_match_x( "", "rt_ap_isolate", "1", "value=1 checked"); %>
                                                        <% nvram_match_x("","rt_ap_isolate", "0", "value=0"); %>>

                                                            <div style="position: absolute; margin-left: -10000px;">
                                                                <input type="radio" value="1" id="rt_ap_isolate_1" name="rt_ap_isolate" class="input" <% nvram_match_x( "",
                                                                    "rt_ap_isolate", "1", "checked"); %>/>
                                                                <#checkbox_Yes#>
                                                                    <input type="radio" value="0" id="rt_ap_isolate_0" name="rt_ap_isolate" class="input" <% nvram_match_x( "",
                                                                        "rt_ap_isolate", "0", "checked"); %>/>
                                                                    <#checkbox_No#>
                                                            </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="4" size="5" name="rt_frag" class="input" value="<% nvram_get_x(" ", "rt_frag "); %>" onKeyPress="return is_number(this,event);"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="3" size="5" name="rt_dtim" class="input" value="<% nvram_get_x(" ", "rt_dtim "); %>" onKeyPress="return is_number(this,event);"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="4" size="5" name="rt_bcn" class="input" value="<% nvram_get_x(" ", "rt_bcn "); %>" onKeyPress="return is_number(this,event);"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="rt_PktAggregate" class="input" onChange="return change_common_rt(this, 'WLANConfig11b', 'rt_PktAggregate')">
                                                            <option value="0" <% nvram_match_x( "", "rt_PktAggregate", "0", "selected"); %>>
                                                                <#btn_Disable#>
                                                            </option>
                                                            <option value="1" <% nvram_match_x( "", "rt_PktAggregate", "1", "selected"); %>>
                                                                <#btn_Enable#> (*)</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td>
                                                        <select name="rt_HT_RDG" class="input">
                                                            ...
                                                            <option value="1" <% nvram_match_x( "", "rt_HT_RDG", "1", "selected"); %>>
                                                                <#btn_Enable#> (Ralink clients only)</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="rt_HT_AutoBA" class="input">
                                                            <option value="0" <% nvram_match_x( "", "rt_HT_AutoBA", "0", "selected"); %>>
                                                                <#btn_Disable#>
                                                            </option>
                                                            <option value="1" <% nvram_match_x( "", "rt_HT_AutoBA", "1", "selected"); %>>
                                                                <#btn_Enable#> (*)</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr id="row_greenfield">
                                                    ...
                                                    <td>
                                                        <select class="input" id="rt_HT_OpMode" name="rt_HT_OpMode" onChange="return change_common_rt(this, 'WLANConfig11b', 'rt_HT_OpMode')">
                                                            <option value="0" <% nvram_match_x( "", "rt_HT_OpMode", "0", "selected"); %>>
                                                                <#btn_Disable#> (*)</option>
                                                            <option value="1" <% nvram_match_x( "", "rt_HT_OpMode", "1", "selected"); %>>
                                                                <#btn_Enable#>
                                                            </option>
                                                        </select>
                                                    </td>
                                                ...
                                                <tr id="row_wme_no_ack">
                                                    ...
                                                    <td>
                                                        <select name="rt_wme_no_ack" id="rt_wme_no_ack" class="input" onChange="return change_common_rt(this, 'WLANConfig11b', 'rt_wme_no_ack')">
                                                            <option value="off" <% nvram_match_x( "", "rt_wme_no_ack", "off", "selected"); %>>
                                                                <#btn_Disable#> (*)</option>
                                                            <option value="on" <% nvram_match_x( "", "rt_wme_no_ack", "on", "selected"); %>>
                                                                <#btn_Enable#>
                                                            </option>
                                                        </select>
                                                    </td>
                                                ...
                                                <tr id="row_apsd_cap">
                                                    ...
                                                    <td>
                                                        <select name="rt_APSDCapable" class="input" onchange="return change_common_rt(this, 'WLANConfig11b', 'rt_APSDCapable')">
                                                            <option value="0" <% nvram_match_x( "", "rt_APSDCapable", "0", "selected"); %> >
                                                                <#btn_Disable#>
                                                            </option>
                                                            <option value="1" <% nvram_match_x( "", "rt_APSDCapable", "1", "selected"); %> >
                                                                <#btn_Enable#> (*)</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                <tr id="row_turbo_qam" style="display:none">
                                                    ...
                                                    <td>
                                                        <select name="rt_turbo_qam" class="input">
                                                            <option value="0" <% nvram_match_x( "", "rt_turbo_qam", "0", "selected"); %>>
                                                                <#btn_Disable#>
                                                            </option>
                                                            <option value="1" <% nvram_match_x( "", "rt_turbo_qam", "1", "selected"); %>>
                                                                <#btn_Enable#> (*)</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                <tr id="row_airtimefairness" style="display:none">
                                                    ...
                                                    <td>
                                                        <select name="rt_airtimefairness" class="input">
                                                            <option value="0" <% nvram_match_x( "", "rt_airtimefairness", "0", "selected"); %>>
                                                                <#btn_Disable#> (*)</option>
                                                            <option value="1" <% nvram_match_x( "", "rt_airtimefairness", "1", "selected"); %>>
                                                                <#btn_Enable#>
                                                            </option>
                                                        </select>
                                                    </td>
