                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                                <tr>
                                                    ...
                                                    <td style="padding-bottom: 0px; border-top: 0 none;">
                                                        ...
                                                        <input type="checkbox" id="modem_rule_fake" <% nvram_match_x( "", "modem_rule", "1", "value=1 checked"); %>
                                                        <% nvram_match_x("", "modem_rule", "0", "value=0"); %>>


                                                            <div style="position: absolute; margin-left: -10000px;">
                                                                <input type="radio" value="1" name="modem_rule" id="modem_rule_1" class="input" <% nvram_match_x( "", "modem_rule", "1",
                                                                    "checked"); %>/>
                                                                <#checkbox_Yes#>
                                                                    <input type="radio" value="0" name="modem_rule" id="modem_rule_0" class="input" <% nvram_match_x( "", "modem_rule", "0",
                                                                        "checked"); %>/>
                                                                    <#checkbox_No#>
                                                            </div>
                                                    </td>
                                            ...
                                            <table class="table" id="tbl_modem_base" style="display:none">
                                                ...
                                                <tr>
                                                    <th>
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,21,10);">
                                                            <#HSDPAConfig_Country_itemname#>:</a>
                                                    </th>
                                                    <td>
                                                ...
                                                <tr id="row_modem_apn">
                                                    <th>
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,21,3);">
                                                            <#HSDPAConfig_private_apn_itemname#>:</a>
                                                    </th>
                                                    <td>
                                                ...
                                                <tr>
                                                    <th>
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,21,2);">
                                                            <#HSDPAConfig_pin_code_itemname#>:</a>
                                                    </th>
                                                    <td>
                                                        <div class="input-append">
                                                            <input id="modem_pin" name="modem_pin" class="input" type="password" maxlength="8" size="32" style="width: 175px;" value="<% nvram_get_x("
                                                                ", "modem_pin "); %>" onkeypress="return is_number(this,event);"
                                                            />
                                                ...
                                                <tr id="row_modem_dial">
                                                    <th>
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,21,11);">
                                                            <#HSDPAConfig_DialNum_itemname#>:</a>
                                                    </th>
                                                    <td>
                                                ...
                                                <tr>
                                                    <th>
                                                        <a class="help_tooltip" href="javascript:void(0);" onmouseover="openTooltip(this,21,12);">
                                                            <#HSDPAConfig_Username_itemname#>:</a>
                                                    </th>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-append">
                                                            <input type="password" name="modem_pass" id="modem_pass" maxlength="32" size="32" style="width: 175px;" value="<% nvram_get_x("
                                                                ", "modem_pass "); %>">
                                            ...
                                            <table class="table" id="tbl_modem_dns" style="display:none">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="modem_dnsa_fake" <% nvram_match_x( "", "modem_dnsa", "1", "value=1 checked"); %>
                                                        <% nvram_match_x("", "modem_dnsa", "0", "value=0"); %>>


                                                            <div style="position: absolute; margin-left: -10000px;">
                                                                <input type="radio" name="modem_dnsa" id="modem_dnsa_1" value="1" onclick="change_modem_dns_auto();" <% nvram_match_x( "",
                                                                    "modem_dnsa", "1", "checked"); %>/>
                                                                <#checkbox_Yes#>
                                                                    <input type="radio" name="modem_dnsa" id="modem_dnsa_0" value="0" onclick="change_modem_dns_auto();" <% nvram_match_x( "",
                                                                        "modem_dnsa", "0", "checked"); %>/>
                                                                    <#checkbox_No#>
                                                            </div>
                                                    </td>
                                                </tr>
