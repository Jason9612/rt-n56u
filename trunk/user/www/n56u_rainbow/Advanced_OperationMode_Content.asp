                                            ...
                                            <center><div id="Senario" class="span12" style="height: 170px;">
                                                <div class="row-fluid">
                                                    <table style="width: 100%">
                                                        ...
                                                        <tr>
                                                            <td><i class="if if-workmode-wirelessdevices"></i></td>
                                                            <td><i class="if if-workmode-arrowleft"></i></td>
                                                            <td><i class="if if-workmode-wirelessrouter"></i></td>
                                                            <td class="AP"><i class="if if-workmode-arrowleft"></i></td>
                                                            <td class="AP"><i class="if if-workmode-mainrouter"></i></td>
                                                            <td><i class="if if-workmode-arrowleft"></i></td>
                                                            <td><i class="if if-workmode-internet"></i></td>
                                                        </tr>
                                                    </table>
                                                </div>
