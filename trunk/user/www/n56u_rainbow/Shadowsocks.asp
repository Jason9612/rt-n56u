					...
					$j.ajax({
						...
						success: function (data) {
							...
							for (var key in db_ss) { // 遍历对象
								var optionObj = JSON.parse(removeUselessChars(db_ss[key])); // 字符串转为对象
							...
							var i = 0;
							for (var key in db_ss) { // 遍历对象
								var dbss = JSON.parse(removeUselessChars(db_ss[key]));
										...
										<div class="row-fluid">
											...
											<div id="wnd_ss_cfg">
												<div class="alert alert-info" style="margin: 10px;">
													...
													<div>
														<span style="color:#E53333;">注意:</span>
													</div>
													<div>
														<span style="color:#E53333;">1.chinadns-ng仅当绕过大陆模式有域名污染时才建议打开来分流防止污染！当然会占用一部分内存。</span>
													</div>
													<div>
														<span style="color:#E53333;">2.服务器确定连上后,网页还是打不开,可尝试切换国外DNS</span>
													</div>
												</div>
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													...
													<tr>
														...
														<td>
															...
															<input type="checkbox" id="ss_enable_fake" <% nvram_match_x( "", "ss_enable", "1", "value=1 checked"); %>
															<% nvram_match_x("", "ss_enable", "0", "value=0"); %>>

																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="ss_enable" id="ss_enable_1" <% nvram_match_x( "", "ss_enable", "1", "checked"); %>>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="ss_enable" id="ss_enable_0" <% nvram_match_x( "", "ss_enable", "0", "checked"); %>>
																		<#checkbox_No#>
																</div>
														</td>
													</tr>
													<tr>
														...
														<td>
															...
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" value="1" name="trojan_local_enable" id="trojan_local_enable_1"
																	<% nvram_match_x("", "trojan_local_enable", "1", "checked"); %>>
																<启用>
																	<input type="radio" value="0" name="trojan_local_enable" id="trojan_local_enable_0"
													...
													<tr>
														...
														<td>
															...
															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" value="1" name="v2_local_enable" id="v2_local_enable_1"
																	<% nvram_match_x("", "v2_local_enable", "1", "checked"); %>>
																<启用>
																	<input type="radio" value="0" name="v2_local_enable" id="v2_local_enable_0"
													...
													<tr>
														...
														<td>
															<select name="ss_run_mode" id="ss_run_mode" class="input" style="width: 200px;">
																<option value="gfw" <% nvram_match_x( "", "ss_run_mode", "gfw", "selected"); %>> gfw列表模式
																</option>
																<option value="router" <% nvram_match_x( "", "ss_run_mode", "router", "selected"); %>> 绕过大陆IP模式
																</option>
																<option value="all" <% nvram_match_x( "", "ss_run_mode", "all", "selected"); %>> 全局模式
																</option>
																<option value="oversea" <% nvram_match_x( "", "ss_run_mode", "oversea", "selected"); %>> 海外用户回国模式
																</option>
															</select>
														</td>
													</tr>
													<tr>
														...
														<td>
															<select name="s_dports" class="input" style="width: 200px;">
																<option value="0" <% nvram_match_x( "", "s_dports", "0", "selected"); %>> 所有端口（默认）
																</option>
																<option value="1" <% nvram_match_x( "", "s_dports", "1", "selected"); %>> 仅常用端口(不走P2P流量到代理)
																</option>
															</select>
														</td>
													</tr>
													...
													<tr>
														...
														<td>
															...
															<input type="checkbox" id="ss_chdns_fake" <% nvram_match_x( "", "ss_chdns", "1", "value=1 checked"); %>
															<% nvram_match_x("", "ss_chdns", "0", "value=0"); %>>

																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="ss_chdns" id="ss_chdns_1" <% nvram_match_x( "", "ss_chdns", "1", "checked"); %>>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="ss_chdns" id="ss_chdns_0" <% nvram_match_x( "", "ss_chdns", "0", "checked"); %>>
																		<#checkbox_No#>
																</div>
														</td>
													</tr>
													<tr id="row_china_dns" style="display:none;">
														...
														<td>
															<select name="china_dns" class="input" style="width: 200px;">
																...
																<option value="114.114.114.114#53">114 DNS (114.114.114.114)
																</option>
																<option value="117.50.11.11#53">OneDNS (117.50.11.11)
																</option>
																<option value="180.76.76.76#53">百度DNS (180.76.76.76)
																</option>
																<option value="119.29.29.29#53">DNSPOD DNS (119.29.29.29)
																</option>
													...
													<tr id="row_tunnel_forward" style="display:none;">
														...
														<td>
															<select name="tunnel_forward" class="input" style="width: 200px;">
																...
																<option value="208.67.222.222#53">OpenDNS (208.67.222.222)
																</option>
																<option value="208.67.220.220#53">OpenDNS (208.67.220.220)
																</option>
																...
																<option value="114.114.114.114#53">Oversea Mode DNS-1 (114.114.114.114)
																</option>
																<option value="114.114.115.115#53">Oversea Mode DNS-1 (114.114.115.115)
																</option>
															</select>
														</td>
													</tr>
												...
												<table class="table">
													<tr>
														<td style="border: 0 none; padding: 0px;">
															<center>
																<input name="button" type="button" class="btn btn-primary" style="width: 200px" onclick="applyRule();" value="应用设置" />
															</center>
														</td>
													</tr>
												</table>
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													...
													<tr id="ss_schedule_enable_tr" width="50%">
														...
														<td>
															...
															<input type="checkbox" id="ss_schedule_enable_fake" <% nvram_match_x( "", "ss_schedule_enable", "1", "value=1 checked");
															 %>
															<% nvram_match_x("", "ss_schedule_enable", "0", "value=0"); %>>


																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" name="ss_schedule_enable_x" id="ss_schedule_enable_1" class="input" value="1" <% nvram_match_x( "",
																	 "ss_schedule_enable", "1", "checked"); %> />
																	<#checkbox_Yes#>
																		<input type="radio" name="ss_schedule_enable_x" id="ss_schedule_enable_0" class="input" value="0" <% nvram_match_x( "",
													...
													<tr id="ss_schedule_time_tr">
														<th>自动更新时间</th>
														<td>
															<input type="text" maxlength="2" class="input_3_table" style="width: 30px" name="ss_time_x_hour" onKeyPress="return validator.isNumber(this,event);"
															 onblur="validator.timeRange(this, 0);" autocorrect="off" autocapitalize="off">时:
															<input type="text" maxlength="2" class="input_3_table" style="width: 30px" name="ss_time_x_min" onKeyPress="return validator.isNumber(this,event);"
												...
												<div id="vpnc_settings" class="contentM_qis" style="z-index:9999; box-shadow: 3px 3px 10px #000;margin-top: 0px;">
													<table width="100%" cellpadding="4" cellspacing="0" class="table" id="sslist">
														...
														<tr id="row_s5_username" style="display:none;">
															<th width="50%">用户名</th>
															<td>
																<input type="password" class="input" size="32" name="s5_username" id="s5_username" value="" />
															</td>
														</tr>
														<tr id="row_s5_password" style="display:none;">
															<th width="50%">密码</th>
															<td>
																<input type="password" class="input" size="32" name="s5_password" id="s5_password" value="" />
														...
														<tr id="row_v2_vid" style="display:none;">
															...
															<td>
																<input type="text" class="input" size="15" name="v2_vmess_id" id="v2_vmess_id" style="width: 200px" value="<% nvram_get_x("
																 ","v2_vid_x_0 "); %>" />
															</td>
														</tr>
														...
														<tr id="row_v2_webs_host" style="display:none;">
															...
															<td>
																<input type="text" class="input" size="15" name="v2_ws_host" id="v2_ws_host" style="width: 200px" value="<% nvram_get_x("
																 ","v2_webs_host_x_0 "); %>" />
															</td>
														</tr>
														<tr id="row_v2_webs_path" style="display:none;">
															...
															<td>
																<input type="text" class="input" size="15" name="v2_ws_path" id="v2_ws_path" style="width: 200px" value="<% nvram_get_x("
																 ","v2_webs_path_x_0 "); %>" />
															</td>
														</tr>
														<tr id="row_v2_http2_host" style="display:none;">
															...
															<td>
																<input type="text" class="input" size="15" name="v2_h2_host" id="v2_h2_host" style="width: 200px" value="<% nvram_get_x("
																 ","v2_http2_host_x_0 "); %>" />
															</td>
														</tr>
														<tr id="row_v2_http2_path" style="display:none;">
															...
															<td>
																<input type="text" class="input" size="15" name="v2_h2_path" id="v2_h2_path" style="width: 200px" value="<% nvram_get_x("
																 ","v2_http2_path_x_0 "); %>" />
															</td>
														</tr>
														...
														<tr>
															<td>
																<center>
																	<input name="ManualRULESList2" id="ManualRULESList2" type="button" class="btn btn-primary" onclick="add_ss();" style="width: 219px"
																	 value="保存节点" />
																</center>
															</td>
															<td>
																<center>
																	<input name="button" type="button" class="btn btn-primary" id="close_add" style="width: 219px" value="取消" />
																</center>
															</td>
														</tr>
													</table>
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													...
													<tr>
														...
														<td>
															...
															<input type="checkbox" id="ss_watchcat_fake" <% nvram_match_x( "", "ss_watchcat", "1", "value=1 checked"); %>
															<% nvram_match_x("", "ss_watchcat", "0", "value=0"); %>>

																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="ss_watchcat" id="ss_watchcat_1" <% nvram_match_x( "", "ss_watchcat", "1", "checked");
																	 %>>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="ss_watchcat" id="ss_watchcat_0" <% nvram_match_x( "", "ss_watchcat", "0", "checked");
																		 %>>
																		<#checkbox_No#>
																</div>
														</td>
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													...
													<tr>
														...
														<td>
															...
															<input type="checkbox" id="ss_update_chnroute_fake" <% nvram_match_x( "", "ss_update_chnroute", "1", "value=1 checked");
															 %>
															<% nvram_match_x("", "ss_update_chnroute", "0", "value=0"); %>>

																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="ss_update_chnroute" id="ss_update_chnroute_1" <% nvram_match_x( "",
																	 "ss_update_chnroute", "1", "checked"); %>>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="ss_update_chnroute" id="ss_update_chnroute_0" <% nvram_match_x( "",
																		 "ss_update_chnroute", "0", "checked"); %>>
																		<#checkbox_No#>
																</div>
														</td>
													</tr>
													...
													<tr>
														...
														<td>
															...
															<input type="checkbox" id="ss_update_gfwlist_fake" <% nvram_match_x( "", "ss_update_gfwlist", "1", "value=1 checked"); %>
															<% nvram_match_x("", "ss_update_gfwlist", "0", "value=0"); %>>

																<div style="position: absolute; margin-left: -10000px;">
																	<input type="radio" value="1" name="ss_update_gfwlist" id="ss_update_gfwlist_1" <% nvram_match_x( "", "ss_update_gfwlist",
																	 "1", "checked"); %>>
																	<#checkbox_Yes#>
																		<input type="radio" value="0" name="ss_update_gfwlist" id="ss_update_gfwlist_0" <% nvram_match_x( "", "ss_update_gfwlist",
																		 "0", "checked"); %>>
																		<#checkbox_No#>
																</div>
														</td>
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													<tr>
														<td colspan="3" style="border-top: 0 none; padding-bottom: 0px;">
															<textarea rows="21" class="span12" style="height:377px; font-family:'Courier New', Courier, mono; font-size:13px;" readonly="readonly"
															 wrap="off" id="textarea"><% nvram_dump("ssrplus.log",""); %></textarea>
														</td>
													</tr>
													<tr>
