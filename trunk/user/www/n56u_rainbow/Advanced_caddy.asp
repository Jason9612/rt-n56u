...
<% login_state_hook(); %>
			...
			function initial() {
				show_banner(2);
				show_menu('if-m1-syssettings', 'if-m2-caddy');
				show_footer();
				show_caddy_stroage();
				show_caddy_dir();
				switch_caddy_type();
								...
								<div class="box well grad_colour_dark_blue">
									...
									<div class="round_bottom">
										<div class="row-fluid">
											...
											<div class="alert alert-info" style="margin: 10px;">File Browser是一个基于GO的轻量级文件管理系统支持登录系统 角色系统、在线PDF、图片、视频浏览、上传下载、打包下载等功能。 WEBDAV 是一种文件服务，类似的服务有 SMB、NFS、FTP 等，特点是基于
												HTTP/HTTPS 协议。
											...
											<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
												...
												<tr>
													...
													<td>
														...
														<input type="checkbox" id="caddy_enable_fake" <% nvram_match_x( "", "caddy_enable", "1", "value=1 checked"); %>
														<% nvram_match_x("", "caddy_enable", "0", "value=0"); %> />

															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" value="1" name="caddy_enable" id="caddy_enable_1" class="input" value="1" <% nvram_match_x( "",
																 "caddy_enable", "1", "checked"); %> />
																<#checkbox_Yes#>
																	<input type="radio" value="0" name="caddy_enable" id="caddy_enable_0" class="input" value="0" <% nvram_match_x( "",
																	 "caddy_enable", "0", "checked"); %> />
																	<#checkbox_No#>
															</div>
													</td>
												</tr>
												...
												<tr>
													...
													<td>
														...
														<input type="checkbox" id="caddy_wan_fake" <% nvram_match_x( "", "caddy_wan", "1", "value=1 checked"); %>
														<% nvram_match_x("", "caddy_wan", "0", "value=0"); %> />

															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" value="1" name="caddy_wan" id="caddy_wan_1" class="input" value="1" <% nvram_match_x( "", "caddy_wan",
																 "1", "checked"); %> />
																<#checkbox_Yes#>
																	<input type="radio" value="0" name="caddy_wan" id="caddy_wan_0" class="input" value="0" <% nvram_match_x( "", "caddy_wan",
																	 "0", "checked"); %> />
																	<#checkbox_No#>
															</div>
													</td>
												...
												<tr>
													...
													<td>
														...
														<input type="checkbox" id="caddy_wip6_fake" <% nvram_match_x( "", "caddy_wip6", "1", "value=1 checked"); %>
														<% nvram_match_x("", "caddy_wip6", "0", "value=0"); %> />

															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" value="1" name="caddy_wip6" id="caddy_wip6_1" class="input" value="1" <% nvram_match_x( "",
																 "caddy_wip6", "1", "checked"); %> />
																<#checkbox_Yes#>
																	<input type="radio" value="0" name="caddy_wip6" id="caddy_wip6_0" class="input" value="0" <% nvram_match_x( "",
																	 "caddy_wip6", "0", "checked"); %> />
																	<#checkbox_No#>
															</div>
													</td>
												</tr>
												...
												<tr>
													...
													<td>
														<input type="text" name="caddyf_wan_port" maxlength="8" class="input" size="60" value="<% nvram_get_x(" ","caddyf_wan_port
														 "); %>" />
														<a href="http://<% nvram_get_x(" ", "lan_ipaddr_t "); %>:<% nvram_get_x(" ","caddyf_wan_port "); %>" target="_blank">打开管理页面</a>
													</td>
												</tr>
												<tr>
													<th>webdav端口:</th>
													<td>
														<input type="text" name="caddyw_wan_port" maxlength="8" class="input" size="60" value="<% nvram_get_x(" ","caddyw_wan_port
														 "); %>" />
														<a href="http://<% nvram_get_x(" ", "lan_ipaddr_t "); %>:<% nvram_get_x(" ","caddyw_wan_port "); %>" target="_blank">打开管理页面</a>
													</td>
												</tr>
												...
												<tr id="row_wpassword" style="display:none;">
													<th width="50%">webdav密码:</th>
													<td>
														<input type="password" class="input" size="32" name="caddy_wpassword" id="w_key" value="<% nvram_get_x(" ","caddy_wpassword
														 "); %>" />
														<button style="margin-left: -5px;" class="btn" type="button" onclick="passwordShowHide('w_key')">
