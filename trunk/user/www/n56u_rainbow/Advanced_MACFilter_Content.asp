                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
										...
										<tr id="mac_drop_row" style="display:none;">
											...
											<td>
												...
												<input type="checkbox" id="fw_mac_drop_fake" <% nvram_match_x( "", "fw_mac_drop", "1", "value=1 checked"); %>
												<% nvram_match_x("", "fw_mac_drop", "0", "value=0"); %>>
										
													<div style="position: absolute; margin-left: -10000px;">
														<input type="radio" value="1" name="fw_mac_drop" id="fw_mac_drop_1" <% nvram_match_x( "", "fw_mac_drop", "1", "checked");
														 %>>
														<#checkbox_Yes#>
															<input type="radio" value="0" name="fw_mac_drop" id="fw_mac_drop_0" <% nvram_match_x( "", "fw_mac_drop", "0", "checked");
															 %>>
															<#checkbox_No#>
													</div>
											</td>
                                        ...
                                        <tr>
                                            <td width="25%">
                                                ...
                                                <div class="input-append">
                                                    ...
                                                    <button class="btn btn-chevron" id="chevron" type="button" onclick="pullLANIPList(this);" title="Select the MAC of LAN clients."><i class="if if-btn-down"></i></button>
                                                </div>
                                            </td>
                                            <td width="25%">
                                            ...
                                            <td width="5%">
                                                <button class="btn" style="max-width: 219px" type="submit" onclick="return markGroupMAC(this, 64, ' Add ');" name="MFList2" value="<#CTL_add#>" size="12"><i class="if if-btn-plus"></i></button>
                                            </td>
                                        </tr>
                                    </table>
