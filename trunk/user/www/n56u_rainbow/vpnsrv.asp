							...
							<div class="round_bottom">
								...
								<div id="wnd_vpns_cfg">
									...
									<table class="table">
										<tr>
											...
											<td style="padding-bottom: 0px; border-top: 0 none;">
												...
												<input type="checkbox" id="vpns_enable_fake" <% nvram_match_x( "", "vpns_enable", "1", "value=1 checked"); %>
												<% nvram_match_x("", "vpns_enable", "0", "value=0"); %>>

													<div style="position: absolute; margin-left: -10000px;">
														<input type="radio" name="vpns_enable" id="vpns_enable_1" class="input" value="1" onclick="change_vpns_enabled();" <% nvram_match_x(
														 "", "vpns_enable", "1", "checked"); %>>
														<#checkbox_Yes#>
															<input type="radio" name="vpns_enable" id="vpns_enable_0" class="input" value="0" onclick="change_vpns_enabled();" <% nvram_match_x(
									...
									<table class="table" id="tbl_vpn_config" style="display:none">
										...
										<tr id="row_vpns_ov_port" style="display:none">
											...
											<td>
												<input type="text" maxlength="5" size="5" name="vpns_ov_port" class="input" value="<% nvram_get_x(" ", "vpns_ov_port
											...
											<td>
												<select name="vpns_ov_ciph" class="input">
													...
													<option value="9" <% nvram_match_x( "", "vpns_ov_ciph", "9",
													 "selected"); %>>[CAMELLIA-128-CBC] CAM, 128 bit</option>
												
													<option value="10" <% nvram_match_x( "", "vpns_ov_ciph", "10",
													 "selected"); %>>[CAMELLIA-192-CBC] CAM, 192 bit</option>
												
													<option value="11" <% nvram_match_x( "", "vpns_ov_ciph", "11",
													 "selected"); %>>[CAMELLIA-256-CBC] CAM, 256 bit</option>
												
													<option value="12" <% nvram_match_x( "", "vpns_ov_ciph", "12",
													 "selected"); %>>[AES-128-GCM] AES-GCM, 128 bit</option>
												
													<option value="13" <% nvram_match_x( "", "vpns_ov_ciph", "13",
													 "selected"); %>>[AES-192-GCM] AES-GCM, 192 bit</option>
												
													<option value="14" <% nvram_match_x( "", "vpns_ov_ciph", "14",
													 "selected"); %>>[AES-256-GCM] AES-GCM, 256 bit</option>
												</select>
											</td>
										</tr>
										<tr id="row_vpns_ov_clzo" style="display:none">
											...
											<td>
												<select name="vpns_ov_clzo" class="input">
													<option value="0" <% nvram_match_x( "", "vpns_ov_clzo", "0", "selected"); %>>
														<#btn_Disable#>
													</option>
													<option value="1" <% nvram_match_x( "", "vpns_ov_clzo", "1", "selected"); %>>
														<#checkbox_No#>
													</option>
													<option value="2" <% nvram_match_x( "", "vpns_ov_clzo", "2", "selected"); %>>
														<#OVPN_CLZO_Item2#> (*)</option>
													<option value="3" <% nvram_match_x( "", "vpns_ov_clzo", "3", "selected"); %>>
														<#OVPN_CLZO_Item3#>
													</option>
												</select>
											</td>
										...
										<tr id="row_vpns_ov_atls" style="display:none" onchange="change_vpns_ov_atls();">
											...
											<td>
												<select name="vpns_ov_atls" class="input">
													<option value="0" <% nvram_match_x( "", "vpns_ov_atls", "0", "selected"); %>>
														<#checkbox_No#>
													</option>
													<option value="1" <% nvram_match_x( "", "vpns_ov_atls", "1", "selected"); %>>
														<#OVPN_HMAC_Item1#>
													</option>
												</select>
											</td>
										...
										<tr id="row_vpns_vnet" style="display:none">
											...
											<td>
												<input type="text" maxlength="15" class="input" size="15" name="vpns_vnet" value="<% nvram_get_x(" ", "vpns_vnet "); %>"
										...
										<tr id="row_vpns_ov_rdgw" style="display:none">
											...
											<td>
												<select name="vpns_ov_rdgw" class="input">
													<option value="0" <% nvram_match_x( "", "vpns_ov_rdgw", "0", "selected"); %>>
														<#checkbox_No#> (*)</option>
													<option value="1" <% nvram_match_x( "", "vpns_ov_rdgw", "1", "selected"); %>>
														<#checkbox_Yes#>
													</option>
												</select>
											</td>
									...
									<table class="table" id="tbl_vpn_pool" style="display:none">
										...
										<tr id="row_pool_edit">
											...
											<td>
												<span id="lanip1"></span>
												<input type="text" maxlength="3" size="2" name="vpns_cli0" value="<% nvram_get_x(" ", "vpns_cli0 "); %>" style="width: 25px;"
												 onKeyPress="return is_number(this,event);" />
												<span>&nbsp;~&nbsp;</span>
												<span id="lanip2"></span>
												<input type="text" maxlength="3" size="2" name="vpns_cli1" value="<% nvram_get_x(" ", "vpns_cli1 "); %>" style="width: 25px;"
												 onKeyPress="return is_number(this,event);" />
											</td>
										</tr>
										<tr id="row_pool_view">
									...
									<table class="table">
										<tr>
											<td style="border: 0 none;">
												<center>
													<input name="button2" type="button" class="btn btn-primary" style="width: 219px" onclick="applyRule();" value="<#CTL_apply#>"
													/>
												</center>
											</td>
										</tr>
								...
								<div id="wnd_vpns_acl" style="display:none">
									...
									<table class="table">
										...
										<tr>
											<td>
												<input type="text" size="14" class="span12" autocomplete="off" maxlength="32" name="vpns_user_x_0" value="<% nvram_get_x("
												 ", "vpns_user_x_0 "); %>" onkeypress="return is_string(this,event);" />
											</td>
											<td>
											...
											<td>
												<span id="vpnip3"></span>
												<input type="text" size="2" maxlength="3" style="width: 25px;" name="vpns_addr_x_0" value="<% nvram_get_x(" ", "vpns_addr_x_0
												 "); %>" onkeypress="return is_number(this,event);" />
											</td>
											<td>
												<input type="text" size="14" maxlength="15" style="width: 90px;" name="vpns_rnet_x_0" value="<% nvram_get_x(" ", "vpns_rnet_x_0
												 "); %>" onkeypress="return is_ipaddr(this,event);" />&nbsp;/
												<input type="text" size="14" maxlength="15" style="width: 90px;" name="vpns_rmsk_x_0" value="<% nvram_get_x(" ", "vpns_rmsk_x_0
												 "); %>" onkeypress="return is_ipaddr(this,event);" />
											</td>
											<td>
												<button class="btn" type="submit" onclick="return markGroupACL(this, 50, ' Add ');" name="VPNSACLList2">
									...
									<table class="table">
										<tr>
											<td style="border: 0 none;">
												<center>
													<input name="button3" type="button" class="btn btn-primary" style="width: 219px" onclick="applyRule();" value="<#CTL_apply#>"
													/>
												</center>
											</td>
										</tr>
