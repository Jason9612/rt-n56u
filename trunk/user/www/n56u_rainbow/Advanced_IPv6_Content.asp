                                        ...
                                        <div class="row-fluid">
                                                ...
                                                <tr id="row_wan_ppe">
                                                    ...
                                                    <td align="left">
                                                        <select class="input" name="ip6_ppe_on" id="ip6_ppe_on">
                                                            <option value="0" <% nvram_match_x( "", "ip6_ppe_on", "0", "selected"); %>>
                                                                <#checkbox_No#>
                                                            </option>
                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table" id="tbl_ip6_sit" style="display:none;">
                                                ...
                                                <tr id="row_ip6_6rd_size">
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="2" style="width: 40px;" class="input" size="4" name="ip6_6rd_size" value="<% nvram_get_x("
                                                            ", "ip6_6rd_size "); %>" onkeypress="return is_number(this,event);"
                                                ...
                                                <tr id="row_ip6_sit_mtu">
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="4" style="width: 40px;" class="input" size="4" name="ip6_sit_mtu" value="<% nvram_get_x("
                                                            ", "ip6_sit_mtu "); %>" onkeypress="return is_number(this,event);" onblur="return validate_range(this, 1280, 1480);"
                                                        />
                                                    </td>
                                                </tr>
                                                <tr id="row_ip6_sit_ttl">
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="3" style="width: 40px;" class="input" size="4" name="ip6_sit_ttl" value="<% nvram_get_x("
                                                            ", "ip6_sit_ttl "); %>" onkeypress="return is_number(this,event);" onblur="return validate_range(this, 1, 255);"
                                                        />
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table" id="tbl_ip6_wan" style="display:none;">
                                                ...
                                                <tr id="row_ip6_wan_dhcp">
                                                    ...
                                                    <td align="left">
                                                        <select class="input" name="ip6_wan_dhcp" onchange="change_ip6_wan_dhcp()">
                                                            ...
                                                            <option value="2" <% nvram_match_x( "", "ip6_wan_dhcp", "2", "selected"); %>>
                                                                <#IP6_WAN_Both#>
                                                            </option>
                                                        </select>
                                                    </td>
                                                ...
                                                <tr id="row_ip6_6rd_dhcp">
                                                    ...
                                                    <td align="left">
                                                        <select class="input" name="ip6_6rd_dhcp" onchange="change_ip6_6rd_dhcp()">
                                                            <option value="0" <% nvram_match_x( "", "ip6_6rd_dhcp", "0", "selected"); %>>
                                                                <#checkbox_No#>
                                                            </option>
                                                            <option value="1" <% nvram_match_x( "", "ip6_6rd_dhcp", "1", "selected"); %>>
                                                                <#checkbox_Yes#>
                                                            </option>
                                                        </select>
                                                    </td>
                                                ...
                                                <tr id="row_ip6_wan_addr">
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="40" style="width: 286px;" class="input" size="30" name="ip6_wan_addr" value="<% nvram_get_x("
                                                            ", "ip6_wan_addr "); %>" onkeypress="return is_string(this,event);"
                                                            onblur="return validate_ip6addr(this);" />
                                                    </td>
                                                </tr>
                                                <tr id="row_ip6_wan_size">
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="3" style="width: 30px;" class="input" size="4" name="ip6_wan_size" value="<% nvram_get_x("
                                                            ", "ip6_wan_size "); %>" onkeypress="return is_number(this,event);"
                                                ...
                                                <tr id="row_ip6_wan_gate">
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="40" style="width: 286px;" class="input" size="30" name="ip6_wan_gate" value="<% nvram_get_x("
                                                            ", "ip6_wan_gate "); %>" onkeypress="return is_string(this,event);"
                                                            onblur="return validate_ip6addr(this);" />
                                                    </td>
                                                </tr>
                                                <tr id="row_ip6_wan_priv" style="display:none;">
                                                    ...
                                                    <td align="left">
                                                        <select class="input" name="ip6_wan_priv">
                                                            <option value="0" <% nvram_match_x( "", "ip6_wan_priv", "0", "selected"); %>>
                                                                <#checkbox_No#> (*)</option>
                                                            <option value="1" <% nvram_match_x( "", "ip6_wan_priv", "1", "selected"); %>>
                                                                <#checkbox_Yes#>
                                                            </option>
                                                        </select>
                                                    </td>
                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table" id="tbl_ip6_dns" style="display:none;">
                                                ...
                                                <tr id="row_ip6_dns_auto">
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="ip6_dns_auto_fake" <% nvram_match_x( "", "ip6_dns_auto", "1", "value=1 checked"); %>
                                                            <% nvram_match_x("", "ip6_dns_auto", "0", "value=0"); %> />
                                                        <div style="position: absolute; margin-left: -10000px;">
                                                            <input type="radio" name="ip6_dns_auto" id="ip6_dns_auto_1" class="input" value="1"
                                                                onclick="change_ip6_dns_auto();" <% nvram_match_x(
                                                                                                                        "", "ip6_dns_auto", "1", "checked"); %> />
                                                            <#checkbox_Yes#>
                                                                <input type="radio" name="ip6_dns_auto" id="ip6_dns_auto_0" class="input" value="0"
                                                                    onclick="change_ip6_dns_auto();" <% nvram_match_x(
                                                ...
                                                <tr id="row_ip6_dns1">
                                                    <th width="50%">
                                                        <#IP6_DNS_Addr#>&nbsp;1:</th>
                                                    <td>
                                                        <input type="text" maxlength="40" style="width: 286px;" class="input" size="30" name="ip6_dns1" value="<% nvram_get_x("
                                                            ", "ip6_dns1 "); %>" onkeypress="return is_string(this,event);" onblur="return validate_ip6addr(this);"
                                                        />
                                                    </td>
                                                </tr>
                                                <tr id="row_ip6_dns2">
                                                    <th width="50%">
                                                        <#IP6_DNS_Addr#>&nbsp;2:</th>
                                                    <td>
                                                        <input type="text" maxlength="40" style="width: 286px;" class="input" size="30" name="ip6_dns2" value="<% nvram_get_x("
                                                            ", "ip6_dns2 "); %>" onkeypress="return is_string(this,event);" onblur="return validate_ip6addr(this);"
                                                        />
                                                    </td>
                                                </tr>
                                                <tr id="row_ip6_dns3">
                                                    <th width="50%">
                                                        <#IP6_DNS_Addr#>&nbsp;3:</th>
                                                    <td>
                                                        <input type="text" maxlength="40" style="width: 286px;" class="input" size="30" name="ip6_dns3" value="<% nvram_get_x("
                                                            ", "ip6_dns3 "); %>" onkeypress="return is_string(this,event);" onblur="return validate_ip6addr(this);"
                                                        />
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table" id="tbl_ip6_lan" style="display:none;">
                                                ...
                                                <tr id="row_ip6_lan_auto">
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="ip6_lan_auto_fake" <% nvram_match_x( "", "ip6_lan_auto", "1", "value=1 checked"); %>
                                                            <% nvram_match_x("", "ip6_lan_auto", "0", "value=0"); %> />
                                                        <div style="position: absolute; margin-left: -10000px;">
                                                            <input type="radio" name="ip6_lan_auto" id="ip6_lan_auto_1" class="input" value="1"
                                                                onclick="change_ip6_lan_auto();" <% nvram_match_x(
                                                                                                                        "", "ip6_lan_auto", "1", "checked"); %> />
                                                            <#checkbox_Yes#>
                                                                <input type="radio" name="ip6_lan_auto" id="ip6_lan_auto_0" class="input" value="0"
                                                                    onclick="change_ip6_lan_auto();" <% nvram_match_x(
                                                ...
                                                <tr id="row_ip6_lan_addr">
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="40" style="width: 286px;" class="input" size="30" name="ip6_lan_addr" value="<% nvram_get_x("
                                                            ", "ip6_lan_addr "); %>" onkeypress="return is_string(this,event);"
                                                            onblur="return validate_ip6addr(this);" />
                                                    </td>
                                                </tr>
                                                <tr id="row_ip6_lan_size">
                                                    ...
                                                    <td>
                                                        <input type="text" maxlength="3" style="width: 30px;" class="input" size="4" name="ip6_lan_size" value="<% nvram_get_x("
                                                            ", "ip6_lan_size "); %>" onkeypress="return is_number(this,event);"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="ip6_lan_radv_fake" <% nvram_match_x( "", "ip6_lan_radv", "1", "value=1 checked"); %>
                                                        <% nvram_match_x("", "ip6_lan_radv", "0", "value=0"); %> />


                                                            <div style="position: absolute; margin-left: -10000px;">
                                                                <input type="radio" name="ip6_lan_radv" id="ip6_lan_radv_1" class="input" value="1" onclick="change_ip6_lan_radv();" <% nvram_match_x(
                                                                    "", "ip6_lan_radv", "1", "checked"); %>/>
                                                                <#checkbox_Yes#>
                                                                    <input type="radio" name="ip6_lan_radv" id="ip6_lan_radv_0" class="input" value="0" onclick="change_ip6_lan_radv();" <% nvram_match_x(
                                                ...
                                                <tr id="row_ip6_lan_dhcp">
                                                    ...
                                                    <td align="left">
                                                        <select class="input" name="ip6_lan_dhcp" onchange="change_ip6_lan_dhcp()">
                                                            <option value="0" <% nvram_match_x( "", "ip6_lan_dhcp", "0", "selected"); %>>
                                                                <#checkbox_No#>
                                                            </option>
                                                ...
                                                <tr id="row_ip6_lan_pool" style="display:none;">
                                                    ...
                                                    <td align="left">
                                                        <span class="input-prepend">
                                                            ...
                                                            <input type="text" name="ip6_lan_sfps_fake" class="ip6_residual"
                                                                size="4" maxlength="4" onkeypress="return is_string(this,event);"
                                                                onblur="return validate_ip6_part(this);" />&nbsp;&nbsp;-&nbsp;&nbsp;</span>
                                                        <span class="input-prepend">
                                                            <span class="add-on">::</span>
                                                            <input type="text" name="ip6_lan_sfpe_fake" class="ip6_residual"
                                                                size="4" maxlength="4" onkeypress="return is_string(this,event);"
                                                                onblur="return validate_ip6_part(this);" />
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr id="row_ip6_lan_life" style="display:none;">
                                                    ...
                                                    <td align="left">
                                                        <input type="text" maxlength="6" size="6" name="ip6_lan_sflt" class="input" value="<% nvram_get_x(" ", "ip6_lan_sflt
