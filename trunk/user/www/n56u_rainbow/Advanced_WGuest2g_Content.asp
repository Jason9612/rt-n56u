                                            ...
                                            <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                                <tr>
                                                    ...
                                                    <td style="border-top: 0 none;">
                                                        ...
                                                        <input type="checkbox" id="rt_guest_enable_fake" <% nvram_match_x( "", "rt_guest_enable", "1", "value=1 checked"); %>
                                                        <% nvram_match_x("", "rt_guest_enable", "0", "value=0"); %>>


                                                            <div style="position: absolute; margin-left: -10000px;">
                                                                <input type="radio" value="1" id="rt_guest_enable_1" name="rt_guest_enable" class="input" onClick="change_guest_enabled(1);"
                                                                    <% nvram_match_x( "", "rt_guest_enable", "1", "checked");
                                                                    %>/>
                                                                <#checkbox_Yes#>
                                                                    <input type="radio" value="0" id="rt_guest_enable_0" name="rt_guest_enable" class="input" onClick="change_guest_enabled(1);"
                                                                        <% nvram_match_x( "", "rt_guest_enable", "0",
                                                                        "checked"); %>/>
                                                                    <#checkbox_No#>
                                                            </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="controls">
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="rt_guest_date_x_Mon"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Mon#>
                                                            </label>
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="rt_guest_date_x_Tue"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Tue#>
                                                            </label>
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="rt_guest_date_x_Wed"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Wed#>
                                                            </label>
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="rt_guest_date_x_Thu"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Thu#>
                                                            </label>
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="rt_guest_date_x_Fri"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Fri#>
                                                            </label>
                                                        </div>
                                                ...
                                                <tr id="row_guest_3" style="display:none;">
                                                    ...
                                                    <td>
                                                        <div class="controls">
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="rt_guest_date_x_Sat"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Sat#>
                                                            </label>
                                                            <label class="checkbox inline">
                                                                <input type="checkbox" class="input" name="rt_guest_date_x_Sun"
                                                                    onChange="return changeDate();" />
                                                                <#DAY_Sun#>
                                                            </label>
                                                        </div>
                                                ...
                                                <tr id="row_guest_6" style="display:none;">
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="rt_guest_closed_fake" <% nvram_match_x( "", "rt_guest_closed", "1", "value=1 checked"); %>
                                                        <% nvram_match_x("", "rt_guest_closed", "0", "value=0"); %>>

                                                            <div style="position: absolute; margin-left: -10000px;">
                                                                <input type="radio" value="1" id="rt_guest_closed_1" name="rt_guest_closed" class="input" <% nvram_match_x( "",
                                                                    "rt_guest_closed", "1", "checked"); %>/>
                                                                <#checkbox_Yes#>
                                                                    <input type="radio" value="0" id="rt_guest_closed_0" name="rt_guest_closed" class="input" <% nvram_match_x( "",
                                                                        "rt_guest_closed", "0", "checked"); %>/>
                                                                    <#checkbox_No#>
                                                            </div>
                                                    </td>
                                                </tr>
                                                <tr id="row_guest_7" style="display:none;">
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="rt_guest_lan_isolate_fake" <% nvram_match_x( "", "rt_guest_lan_isolate", "1",
                                                            "value=1 checked"); %>
                                                        <% nvram_match_x("", "rt_guest_lan_isolate", "0", "value=0"); %>>


                                                            <div style="position: absolute; margin-left: -10000px;">
                                                                <input type="radio" value="1" id="rt_guest_lan_isolate_1" name="rt_guest_lan_isolate" class="input" <% nvram_match_x( "",
                                                                    "rt_guest_lan_isolate", "1", "checked"); %>/>
                                                                <#checkbox_Yes#>
                                                                    <input type="radio" value="0" id="rt_guest_lan_isolate_0" name="rt_guest_lan_isolate" class="input" <% nvram_match_x( "",
                                                                        "rt_guest_lan_isolate", "0", "checked"); %>/>
                                                                    <#checkbox_No#>
                                                            </div>
                                                    </td>
                                                </tr>
                                                <tr id="row_guest_8" style="display:none;">
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="rt_guest_ap_isolate_fake" <% nvram_match_x( "", "rt_guest_ap_isolate", "1", "value=1 checked");
                                                            %>
                                                        <% nvram_match_x("", "rt_guest_ap_isolate", "0", "value=0"); %>>


                                                            <div style="position: absolute; margin-left: -10000px;">
                                                                <input type="radio" value="1" id="rt_guest_ap_isolate_1" name="rt_guest_ap_isolate" class="input" <% nvram_match_x( "",
                                                                    "rt_guest_ap_isolate", "1", "checked"); %>/>
                                                                <#checkbox_Yes#>
                                                                    <input type="radio" value="0" id="rt_guest_ap_isolate_0" name="rt_guest_ap_isolate" class="input" <% nvram_match_x( "",
                                                                        "rt_guest_ap_isolate", "0", "checked"); %>/>
                                                                    <#checkbox_No#>
                                                            </div>
                                                    </td>
                                                </tr>
                                                <tr id="row_guest_9" style="display:none;">
                                                    ...
                                                    <td>
                                                        <select name="rt_guest_mcs_mode" class="input">
                                                            <option value="0" <% nvram_match_x( "", "rt_guest_mcs_mode", "0", "selected"); %>>
                                                                <#checkbox_No#> (*)</option>
                                                ...
                                                <tr id="row_guest_10" style="display:none;">
                                                    ...
                                                    <td>
                                                        <select name="rt_guest_auth_mode" class="input" onChange="change_guest_auth_mode(1);">
                                                            ...
                                                            <option value="psk" <% nvram_double_match_x( "", "rt_guest_auth_mode", "psk", "", "rt_guest_wpa_mode", "1", "selected");
                                                                %>>WPA-Personal</option>
                                                            <option value="psk" <% nvram_double_match_x( "", "rt_guest_auth_mode", "psk", "", "rt_guest_wpa_mode", "2", "selected");
                                                                %>>WPA2-Personal</option>
                                                            <option value="psk" <% nvram_double_match_x( "", "rt_guest_auth_mode", "psk", "", "rt_guest_wpa_mode", "0", "selected");
                                                ...
                                                <tr id="row_guest_13" style="display:none;">
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="rt_guest_macrule_fake" <% nvram_match_x( "", "rt_guest_macrule", "1", "value=1 checked"); %>
                                                        <% nvram_match_x("", "rt_guest_macrule", "0", "value=0"); %>>

                                                            <div style="position: absolute; margin-left: -10000px;">
                                                                <input type="radio" value="1" id="rt_guest_macrule_1" name="rt_guest_macrule" class="input" <% nvram_match_x( "",
                                                                    "rt_guest_macrule", "1", "checked"); %>/>
                                                                <#checkbox_Yes#>
                                                                    <input type="radio" value="0" id="rt_guest_macrule_0" name="rt_guest_macrule" class="input" <% nvram_match_x( "",
                                                                        "rt_guest_macrule", "0", "checked"); %>/>
                                                                    <#checkbox_No#>
                                                            </div>
                                                    </td>
                                                </tr>
