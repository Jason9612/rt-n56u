									...
									<div class="round_bottom">
										<div class="row-fluid">
											...
											<table width="100%" cellpadding="4" cellspacing="0" class="table">
												...
												<tr>
													...
													<td>
														...
														<input type="checkbox" id="upnp_enable_x_fake" <% nvram_match_x( "", "upnp_enable_x", "1", "value=1 checked"); %>
														<% nvram_match_x("", "upnp_enable_x", "0", "value=0"); %>>


															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" value="1" name="upnp_enable_x" id="upnp_enable_x_1" onclick="change_upnp_enabled();" <% nvram_match_x(
																 "", "upnp_enable_x", "1", "checked"); %>/>
																<#checkbox_Yes#>
																	<input type="radio" value="0" name="upnp_enable_x" id="upnp_enable_x_0" onclick="change_upnp_enabled();" <% nvram_match_x(
																	 "", "upnp_enable_x", "0", "checked"); %>/>
																	<#checkbox_No#>
															</div>
													</td>
												</tr>
												...
												<tr id="row_upnp_eports">
													...
													<td>
														<input type="text" maxlength="5" class="input" size="10" style="width: 94px;" name="upnp_eport_min" value="<% nvram_get_x("
														 ", "upnp_eport_min "); %>" onkeypress="return is_number(this,event);" />&nbsp;-
														<input type="text" maxlength="5" class="input" size="10" style="width: 94px;" name="upnp_eport_max" value="<% nvram_get_x("
														 ", "upnp_eport_max "); %>" onkeypress="return is_number(this,event);" /> &nbsp;
												...
												<tr id="row_upnp_iports">
													...
													<td>
														<input type="text" maxlength="5" class="input" size="10" style="width: 94px;" name="upnp_iport_min" value="<% nvram_get_x("
														 ", "upnp_iport_min "); %>" onkeypress="return is_number(this,event);" />&nbsp;-
														<input type="text" maxlength="5" class="input" size="10" style="width: 94px;" name="upnp_iport_max" value="<% nvram_get_x("
														 ", "upnp_iport_max "); %>" onkeypress="return is_number(this,event);" /> &nbsp;
														<span style="color:#888;">[1..65535]</span>
													</td>
												</tr>
												<tr id="row_upnp_clean_int">
													...
													<td>
														<input type="text" maxlength="5" class="input" size="32" name="upnp_clean_int" value="<% nvram_get_x(" ", "upnp_clean_int
												...
												<tr id="row_upnp_clean_min">
													...
													<td>
														<input type="text" maxlength="3" class="input" size="32" name="upnp_clean_min" value="<% nvram_get_x(" ", "upnp_clean_min
														 "); %>" onkeypress="return is_number(this,event);" /> &nbsp;
											...
											<table width="100%" cellpadding="4" cellspacing="0" class="table">
												...
												<tr>
													...
													<td>
														...
														<input type="checkbox" id="vts_enable_x_fake" <% nvram_match_x( "", "vts_enable_x", "1", "value=1 checked"); %>
														<% nvram_match_x("", "vts_enable_x", "0", "value=0"); %> />


															<div style="position: absolute; margin-left: -10000px;">
																<input type="radio" value="1" name="vts_enable_x" id="vts_enable_x_1" onclick="change_vts_enabled();" <% nvram_match_x(
																 "", "vts_enable_x", "1", "checked"); %>/>
																<#checkbox_Yes#>
																	<input type="radio" value="0" name="vts_enable_x" id="vts_enable_x_0" onclick="change_vts_enabled();" <% nvram_match_x(
																	 "", "vts_enable_x", "0", "checked"); %>/>
																	<#checkbox_No#>
															</div>
													</td>
												</tr>
											...
											<table width="100%" cellpadding="4" cellspacing="0" class="table table-list" id="VSList_Block">
												...
												<tr>
													<td>
														<input type="text" size="10" class="span12" maxlength="30" name="vts_desc_x_0" value="<% nvram_get_x(" ", "vts_desc_x_0
														 "); %>" onkeypress="return is_string(this,event);" />
													</td>
													<td>
														<input type="text" size="12" class="span12" maxlength="15" name="vts_srcip_x_0" value="<% nvram_get_x(" ", "vts_srcip_x_0
														 "); %>" onKeyPress="return is_iprange(this,event);" />
													</td>
													<td>
														...
														/>
														<input style="display:none" type="text" class="span12" maxlength="3" size="3" name="vts_protono_x_0" value="<% nvram_get_x("
														 ", "vts_protono_x_0 "); %>" onkeypress="return is_number(this,event);" />
													</td>
													<td>
														<div id="ClientList_Block" class="alert alert-info ddown-list"></div>
														<div class="input-append">
															<input type="text" size="12" maxlength="15" name="vts_ipaddr_x_0" value="<% nvram_get_x(" ", "vts_ipaddr_x_0 "); %>" onkeypress="return is_ipaddr(this,event);"
															 style="float:left; width: 94px" />
													...
													<td>
														<input type="text" size="5" class="span12" maxlength="5" name="vts_lport_x_0" value="<% nvram_get_x(" ", "vts_lport_x_0
														 "); %>" onkeypress="return is_number(this,event);" />
													</td>
													<td>
